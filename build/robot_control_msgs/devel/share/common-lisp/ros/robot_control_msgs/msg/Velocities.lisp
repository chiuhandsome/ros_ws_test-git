...
(cl:defmethod cl:initialize-instance :after ((m <Velocities>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Velocities)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_control_msgs-msg:<Velocities> is deprecated: use robot_control_msgs-msg:Velocities instead.")))

(cl:ensure-generic-function 'linear_x-val :lambda-list '(m))
(cl:defmethod linear_x-val ((m <Velocities>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_control_msgs-msg:linear_x-val is deprecated.  Use robot_control_msgs-msg:linear_x instead.")
  (linear_x m))

(cl:ensure-generic-function 'linear_y-val :lambda-list '(m))
(cl:defmethod linear_y-val ((m <Velocities>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_control_msgs-msg:linear_y-val is deprecated.  Use robot_control_msgs-msg:linear_y instead.")
  (linear_y m))

(cl:ensure-generic-function 'angular_z-val :lambda-list '(m))
(cl:defmethod angular_z-val ((m <Velocities>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_control_msgs-msg:angular_z-val is deprecated.  Use robot_control_msgs-msg:angular_z instead.")
  (angular_z m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Velocities>)))
  ...
  (cl:format cl:nil "# come from lino_msgs~%float32 linear_x~%float32 linear_y~%float32 angular_z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Velocities)))
  "Returns full string definition for message of type 'Velocities"
  (cl:format cl:nil "# come from lino_msgs~%float32 linear_x~%float32 linear_y~%float32 angular_z~%~%~%"))
