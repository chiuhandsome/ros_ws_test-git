...
;//! \htmlinclude robot_ctrl_alarmCode.msg.html

(cl:defclass <robot_ctrl_alarmCode> (roslisp-msg-protocol:ros-message)
  ((system_id
    :reader system_id
    :initarg :system_id
    :type cl:string
...
(cl:defclass robot_ctrl_alarmCode (<robot_ctrl_alarmCode>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <robot_ctrl_alarmCode>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'robot_ctrl_alarmCode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_control_msgs-msg:<robot_ctrl_alarmCode> is deprecated: use robot_control_msgs-msg:robot_ctrl_alarmCode instead.")))

(cl:ensure-generic-function 'system_id-val :lambda-list '(m))
(cl:defmethod system_id-val ((m <robot_ctrl_alarmCode>))
...
(cl:defmethod alarm_id-val ((m <robot_ctrl_alarmCode>))
...
(cl:defmethod alarm_code-val ((m <robot_ctrl_alarmCode>))
...
(cl:defmethod alarm_level-val ((m <robot_ctrl_alarmCode>))
...
(cl:defmethod alarm_Desc_E-val ((m <robot_ctrl_alarmCode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_control_msgs-msg:alarm_Desc_E-val is deprecated.  Use robot_control_msgs-msg:alarm_Desc_E instead.")
  (alarm_Desc_E m))

(cl:ensure-generic-function 'alarm_Desc_TC-val :lambda-list '(m))
(cl:defmethod alarm_Desc_TC-val ((m <robot_ctrl_alarmCode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_control_msgs-msg:alarm_Desc_TC-val is deprecated.  Use robot_control_msgs-msg:alarm_Desc_TC instead.")
  (alarm_Desc_TC m))

(cl:ensure-generic-function 'alarm_Desc_SC-val :lambda-list '(m))
(cl:defmethod alarm_Desc_SC-val ((m <robot_ctrl_alarmCode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_control_msgs-msg:alarm_Desc_SC-val is deprecated.  Use robot_control_msgs-msg:alarm_Desc_SC instead.")
  (alarm_Desc_SC m))

(cl:ensure-generic-function 'alarm_version-val :lambda-list '(m))
(cl:defmethod alarm_version-val ((m <robot_ctrl_alarmCode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_control_msgs-msg:alarm_version-val is deprecated.  Use robot_control_msgs-msg:alarm_version instead.")
  (alarm_version m))

(cl:ensure-generic-function 'update_time-val :lambda-list '(m))
(cl:defmethod update_time-val ((m <robot_ctrl_alarmCode>))
  ...
  (update_time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <robot_ctrl_alarmCode>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <robot_ctrl_alarmCode>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_ctrl_alarmCode>)))
  "Returns string type for a message object of type '<robot_ctrl_alarmCode>"
  "robot_control_msgs/robot_ctrl_alarmCode")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_ctrl_alarmCode)))
  "Returns string type for a message object of type 'robot_ctrl_alarmCode"
  "robot_control_msgs/robot_ctrl_alarmCode")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<robot_ctrl_alarmCode>)))
  "Returns md5sum for a message object of type '<robot_ctrl_alarmCode>"
  "bae755048a38830c24c3ddbc4bcb4411")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'robot_ctrl_alarmCode)))
  "Returns md5sum for a message object of type 'robot_ctrl_alarmCode"
  "bae755048a38830c24c3ddbc4bcb4411")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robot_ctrl_alarmCode>)))
  "Returns full string definition for message of type '<robot_ctrl_alarmCode>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robot_ctrl_alarmCode)))
  "Returns full string definition for message of type 'robot_ctrl_alarmCode"
  (cl:format cl:nil "string system_id 			~%string alarm_id 		# module_no(3) + module alarm code(3)	~%string alarm_code 		# same as alarm_id,preper for special requirement~%string alarm_level 		# level of ararm: 1:alart 2:alarm	~%string alarm_Desc_E 		# English description of alarm	~%string alarm_Desc_TC 		# Traditional chinese description of alarm	~%string alarm_Desc_SC 		# Sample chinese description of alarm~%string alarm_version 		# version of alarm~%string update_time 		# version time of alarm~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <robot_ctrl_alarmCode>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <robot_ctrl_alarmCode>))
  "Converts a ROS message object to a list"
  (cl:list 'robot_ctrl_alarmCode
