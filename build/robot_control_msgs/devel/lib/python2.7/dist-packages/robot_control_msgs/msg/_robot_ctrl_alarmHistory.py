...
"""autogenerated by genpy from robot_control_msgs/robot_ctrl_alarmHistory.msg. Do not edit."""
import sys
...
class robot_ctrl_alarmHistory(genpy.Message):
  _md5sum = "9b1377e9612e5919160e7b5630dcb6dc"
  _type = "robot_control_msgs/robot_ctrl_alarmHistory"
...
string update_time 
"""
  __slots__ = ['system_id','alarm_id','alarm_code','alarm_level','alarm_occure_time','update_time']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       system_id,alarm_id,alarm_code,alarm_level,alarm_occure_time,update_time
    ...
    """
    if args or kwds:
      super(robot_ctrl_alarmHistory, self).__init__(*args, **kwds)
      ...
      if self.alarm_level is None:
        self.alarm_level = ''
      if self.alarm_occure_time is None:
        self.alarm_occure_time = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.alarm_occure_time = str[start:end].decode('utf-8')
      else:
        self.alarm_occure_time = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
