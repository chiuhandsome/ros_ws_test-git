...
if(actionlib_pnp_controller_CONFIG_INCLUDED)
  return()
endif()
set(actionlib_pnp_controller_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(actionlib_pnp_controller_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/actionlib_controller/actionlib_pnp_controller)
  set(actionlib_pnp_controller_DEVEL_PREFIX /home/handsome/ros_ws_test/build/actionlib_pnp_controller/devel)
  set(actionlib_pnp_controller_INSTALL_PREFIX "")
  set(actionlib_pnp_controller_PREFIX ${actionlib_pnp_controller_DEVEL_PREFIX})
else()
  set(actionlib_pnp_controller_SOURCE_PREFIX "")
  set(actionlib_pnp_controller_DEVEL_PREFIX "")
  set(actionlib_pnp_controller_INSTALL_PREFIX /home/handsome/ros_ws_test/install/actionlib_pnp_controller)
  set(actionlib_pnp_controller_PREFIX ${actionlib_pnp_controller_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'actionlib_pnp_controller' is deprecated")
...
set(actionlib_pnp_controller_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/handsome/ros_ws_test/src/ros_base/actionlib_controller/actionlib_pnp_controller/include " STREQUAL " ")
  set(actionlib_pnp_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/src/ros_base/actionlib_controller/actionlib_pnp_controller/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${actionlib_pnp_controller_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'actionlib_pnp_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'actionlib_pnp_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/actionlib_controller/actionlib_pnp_controller/${idir}'.  ${_report}")
    endif()
    _list_append_unique(actionlib_pnp_controller_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "actionlib_pnp_controller")
foreach(library ${libraries})
  # keep build configuration keywords, target names and absolute libraries as-is
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND actionlib_pnp_controller_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND actionlib_pnp_controller_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT actionlib_pnp_controller_NUM_DUMMY_TARGETS)
      set(actionlib_pnp_controller_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::actionlib_pnp_controller::wrapped-linker-option${actionlib_pnp_controller_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR actionlib_pnp_controller_NUM_DUMMY_TARGETS "${actionlib_pnp_controller_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::actionlib_pnp_controller::wrapped-linker-option${actionlib_pnp_controller_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND actionlib_pnp_controller_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(actionlib_pnp_controller_LIBRARY_DIRS ${lib_path})
      list(APPEND actionlib_pnp_controller_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'actionlib_pnp_controller'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND actionlib_pnp_controller_LIBRARIES ${lib})
    endif()
  endif()
...
set(actionlib_pnp_controller_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${actionlib_pnp_controller_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 actionlib_pnp_controller_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${actionlib_pnp_controller_dep}_FOUND)
      find_package(${actionlib_pnp_controller_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${actionlib_pnp_controller_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(actionlib_pnp_controller_INCLUDE_DIRS ${${actionlib_pnp_controller_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(actionlib_pnp_controller_LIBRARIES ${actionlib_pnp_controller_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${actionlib_pnp_controller_dep}_LIBRARIES})
  _list_append_deduplicate(actionlib_pnp_controller_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(actionlib_pnp_controller_LIBRARIES ${actionlib_pnp_controller_LIBRARIES})

  _list_append_unique(actionlib_pnp_controller_LIBRARY_DIRS ${${actionlib_pnp_controller_dep}_LIBRARY_DIRS})
  list(APPEND actionlib_pnp_controller_EXPORTED_TARGETS ${${actionlib_pnp_controller_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${actionlib_pnp_controller_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
