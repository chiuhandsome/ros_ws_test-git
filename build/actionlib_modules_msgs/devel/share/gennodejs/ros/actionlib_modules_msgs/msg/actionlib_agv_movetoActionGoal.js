...
class actionlib_agv_movetoActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new actionlib_agv_movetoGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = actionlib_agv_movetoGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new actionlib_agv_movetoActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = actionlib_agv_movetoGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += actionlib_agv_movetoGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new actionlib_agv_movetoActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = actionlib_agv_movetoGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new actionlib_agv_movetoGoal()
    }
...
module.exports = actionlib_agv_movetoActionGoal;
