...
class actionlib_power_undockFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new actionlib_power_undockFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new actionlib_power_undockFeedback(null);
...
module.exports = actionlib_power_undockFeedback;
