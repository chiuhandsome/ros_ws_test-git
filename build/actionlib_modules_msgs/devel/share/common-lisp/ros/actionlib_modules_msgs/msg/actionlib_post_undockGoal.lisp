...
;//! \htmlinclude actionlib_post_undockGoal.msg.html

(cl:defclass <actionlib_post_undockGoal> (roslisp-msg-protocol:ros-message)
  ((call_aclib_name
...
(cl:defclass actionlib_post_undockGoal (<actionlib_post_undockGoal>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <actionlib_post_undockGoal>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'actionlib_post_undockGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name actionlib_modules_msgs-msg:<actionlib_post_undockGoal> is deprecated: use actionlib_modules_msgs-msg:actionlib_post_undockGoal instead.")))

(cl:ensure-generic-function 'call_aclib_name-val :lambda-list '(m))
(cl:defmethod call_aclib_name-val ((m <actionlib_post_undockGoal>))
...
(cl:defmethod dock_pose-val ((m <actionlib_post_undockGoal>))
...
(cl:defmethod dock_id-val ((m <actionlib_post_undockGoal>))
...
(cl:defmethod use_move_base-val ((m <actionlib_post_undockGoal>))
...
(cl:defmethod post_time-val ((m <actionlib_post_undockGoal>))
...
(cl:defmethod use_timeout-val ((m <actionlib_post_undockGoal>))
...
(cl:defmethod timeout-val ((m <actionlib_post_undockGoal>))
  ...
  (timeout m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <actionlib_post_undockGoal>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <actionlib_post_undockGoal>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<actionlib_post_undockGoal>)))
  "Returns string type for a message object of type '<actionlib_post_undockGoal>"
  "actionlib_modules_msgs/actionlib_post_undockGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'actionlib_post_undockGoal)))
  "Returns string type for a message object of type 'actionlib_post_undockGoal"
  "actionlib_modules_msgs/actionlib_post_undockGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<actionlib_post_undockGoal>)))
  "Returns md5sum for a message object of type '<actionlib_post_undockGoal>"
  "9c7a95ee383b31fc48324995326aa2f7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'actionlib_post_undockGoal)))
  "Returns md5sum for a message object of type 'actionlib_post_undockGoal"
  "9c7a95ee383b31fc48324995326aa2f7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<actionlib_post_undockGoal>)))
  "Returns full string definition for message of type '<actionlib_post_undockGoal>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'actionlib_post_undockGoal)))
  "Returns full string definition for message of type 'actionlib_post_undockGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Define the goal~%string call_aclib_name~%geometry_msgs/PoseStamped dock_pose~%string dock_id~%bool use_move_base~%float32 post_time~%bool use_timeout~%float32 timeout~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <actionlib_post_undockGoal>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <actionlib_post_undockGoal>))
  "Converts a ROS message object to a list"
  (cl:list 'actionlib_post_undockGoal
