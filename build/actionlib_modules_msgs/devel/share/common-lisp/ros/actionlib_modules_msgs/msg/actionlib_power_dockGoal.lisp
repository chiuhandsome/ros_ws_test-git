...
;//! \htmlinclude actionlib_power_dockGoal.msg.html

(cl:defclass <actionlib_power_dockGoal> (roslisp-msg-protocol:ros-message)
  ((call_aclib_name
...
(cl:defclass actionlib_power_dockGoal (<actionlib_power_dockGoal>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <actionlib_power_dockGoal>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'actionlib_power_dockGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name actionlib_modules_msgs-msg:<actionlib_power_dockGoal> is deprecated: use actionlib_modules_msgs-msg:actionlib_power_dockGoal instead.")))

(cl:ensure-generic-function 'call_aclib_name-val :lambda-list '(m))
(cl:defmethod call_aclib_name-val ((m <actionlib_power_dockGoal>))
...
(cl:defmethod dock_pose-val ((m <actionlib_power_dockGoal>))
...
(cl:defmethod dock_id-val ((m <actionlib_power_dockGoal>))
...
(cl:defmethod use_move_base-val ((m <actionlib_power_dockGoal>))
...
(cl:defmethod post_time-val ((m <actionlib_power_dockGoal>))
...
(cl:defmethod use_timeout-val ((m <actionlib_power_dockGoal>))
...
(cl:defmethod timeout-val ((m <actionlib_power_dockGoal>))
  ...
  (timeout m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <actionlib_power_dockGoal>) ostream)
  "Serializes a message object of type '<actionlib_power_dockGoal>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <actionlib_power_dockGoal>) istream)
  "Deserializes a message object of type '<actionlib_power_dockGoal>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<actionlib_power_dockGoal>)))
  "Returns string type for a message object of type '<actionlib_power_dockGoal>"
  "actionlib_modules_msgs/actionlib_power_dockGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'actionlib_power_dockGoal)))
  "Returns string type for a message object of type 'actionlib_power_dockGoal"
  "actionlib_modules_msgs/actionlib_power_dockGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<actionlib_power_dockGoal>)))
  "Returns md5sum for a message object of type '<actionlib_power_dockGoal>"
  "9c7a95ee383b31fc48324995326aa2f7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'actionlib_power_dockGoal)))
  "Returns md5sum for a message object of type 'actionlib_power_dockGoal"
  "9c7a95ee383b31fc48324995326aa2f7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<actionlib_power_dockGoal>)))
  "Returns full string definition for message of type '<actionlib_power_dockGoal>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'actionlib_power_dockGoal)))
  "Returns full string definition for message of type 'actionlib_power_dockGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Define the goal~%string call_aclib_name~%geometry_msgs/PoseStamped dock_pose~%string dock_id~%bool use_move_base~%float32 post_time~%bool use_timeout~%float32 timeout~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <actionlib_power_dockGoal>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <actionlib_power_dockGoal>))
  "Converts a ROS message object to a list"
  (cl:list 'actionlib_power_dockGoal
