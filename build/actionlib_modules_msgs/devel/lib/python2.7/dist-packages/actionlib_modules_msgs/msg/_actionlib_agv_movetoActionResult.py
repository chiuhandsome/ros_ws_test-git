...
"""autogenerated by genpy from actionlib_modules_msgs/actionlib_agv_movetoActionResult.msg. Do not edit."""
import sys
...
class actionlib_agv_movetoActionResult(genpy.Message):
  _md5sum = "70016b80a6e9008a1b4bee28539a0656"
  _type = "actionlib_modules_msgs/actionlib_agv_movetoActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionlib_modules_msgs/actionlib_agv_movetoResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(actionlib_agv_movetoActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = actionlib_modules_msgs.msg.actionlib_agv_movetoResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = actionlib_modules_msgs.msg.actionlib_agv_movetoResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B2i().pack(_x.result.result, _x.result.result_code.component, _x.result.result_code.result_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.result, _x.result.result_code.component, _x.result.result_code.result_code,) = _get_struct_B2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.result_code.message = str[start:end].decode('utf-8')
      else:
