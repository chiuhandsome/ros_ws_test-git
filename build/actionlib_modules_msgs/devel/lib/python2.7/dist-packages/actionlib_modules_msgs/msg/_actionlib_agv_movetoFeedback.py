...
"""autogenerated by genpy from actionlib_modules_msgs/actionlib_agv_movetoFeedback.msg. Do not edit."""
import sys
...
class actionlib_agv_movetoFeedback(genpy.Message):
  _md5sum = "731b38cf0756acb428661980c367590e"
  _type = "actionlib_modules_msgs/actionlib_agv_movetoFeedback"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(actionlib_agv_movetoFeedback, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.state.global_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.state.local_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.state.goal.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.state.current_velocity.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.state.command_velocity.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.state.global_plan.header.frame_id = str[start:end].decode('utf-8')
      else:
