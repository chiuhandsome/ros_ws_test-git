...
"""autogenerated by genpy from actionlib_modules_msgs/actionlib_agv_movetoResult.msg. Do not edit."""
import sys
...
class actionlib_agv_movetoResult(genpy.Message):
  _md5sum = "e2274c42394ce6b5fa678d84f0f7eed0"
  _type = "actionlib_modules_msgs/actionlib_agv_movetoResult"
...
"""
  ...
  __slots__ = ['result','result_code']
  _slot_types = ['uint8','locomotor_msgs/ResultCode']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(actionlib_agv_movetoResult, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B2i().pack(_x.result, _x.result_code.component, _x.result_code.result_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result, _x.result_code.component, _x.result_code.result_code,) = _get_struct_B2i().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.result_code.message = str[start:end].decode('utf-8')
      else:
