...
if(tug_example_pnp_server_CONFIG_INCLUDED)
  return()
endif()
set(tug_example_pnp_server_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(tug_example_pnp_server_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/PNPros/example/tug_example_pnp_server)
  set(tug_example_pnp_server_DEVEL_PREFIX /home/handsome/ros_ws_test/build/tug_example_pnp_server/devel)
  set(tug_example_pnp_server_INSTALL_PREFIX "")
  set(tug_example_pnp_server_PREFIX ${tug_example_pnp_server_DEVEL_PREFIX})
else()
  set(tug_example_pnp_server_SOURCE_PREFIX "")
  set(tug_example_pnp_server_DEVEL_PREFIX "")
  set(tug_example_pnp_server_INSTALL_PREFIX /home/handsome/ros_ws_test/install/tug_example_pnp_server)
  set(tug_example_pnp_server_PREFIX ${tug_example_pnp_server_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'tug_example_pnp_server' is deprecated")
...
set(tug_example_pnp_server_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/handsome/ros_ws_test/src/ros_base/PNPros/example/tug_example_pnp_server/include " STREQUAL " ")
  set(tug_example_pnp_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/src/ros_base/PNPros/example/tug_example_pnp_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${tug_example_pnp_server_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tug_example_pnp_server' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'tug_example_pnp_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/PNPros/example/tug_example_pnp_server/${idir}'.  ${_report}")
    endif()
    _list_append_unique(tug_example_pnp_server_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND tug_example_pnp_server_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND tug_example_pnp_server_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT tug_example_pnp_server_NUM_DUMMY_TARGETS)
      set(tug_example_pnp_server_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::tug_example_pnp_server::wrapped-linker-option${tug_example_pnp_server_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR tug_example_pnp_server_NUM_DUMMY_TARGETS "${tug_example_pnp_server_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::tug_example_pnp_server::wrapped-linker-option${tug_example_pnp_server_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND tug_example_pnp_server_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(tug_example_pnp_server_LIBRARY_DIRS ${lib_path})
      list(APPEND tug_example_pnp_server_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'tug_example_pnp_server'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND tug_example_pnp_server_LIBRARIES ${lib})
    endif()
  endif()
...
set(tug_example_pnp_server_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${tug_example_pnp_server_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "actionlib;roscpp;pnp_ros;tug_example_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 tug_example_pnp_server_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${tug_example_pnp_server_dep}_FOUND)
      find_package(${tug_example_pnp_server_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tug_example_pnp_server_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(tug_example_pnp_server_INCLUDE_DIRS ${${tug_example_pnp_server_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(tug_example_pnp_server_LIBRARIES ${tug_example_pnp_server_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${tug_example_pnp_server_dep}_LIBRARIES})
  _list_append_deduplicate(tug_example_pnp_server_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(tug_example_pnp_server_LIBRARIES ${tug_example_pnp_server_LIBRARIES})

  _list_append_unique(tug_example_pnp_server_LIBRARY_DIRS ${${tug_example_pnp_server_dep}_LIBRARY_DIRS})
  list(APPEND tug_example_pnp_server_EXPORTED_TARGETS ${${tug_example_pnp_server_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${tug_example_pnp_server_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
