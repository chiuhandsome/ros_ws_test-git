...
if(stated_roslaunch_CONFIG_INCLUDED)
  return()
endif()
set(stated_roslaunch_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(stated_roslaunch_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/stated_roslaunch)
  set(stated_roslaunch_DEVEL_PREFIX /home/handsome/ros_ws_test/build/stated_roslaunch/devel)
  set(stated_roslaunch_INSTALL_PREFIX "")
  set(stated_roslaunch_PREFIX ${stated_roslaunch_DEVEL_PREFIX})
else()
  set(stated_roslaunch_SOURCE_PREFIX "")
  set(stated_roslaunch_DEVEL_PREFIX "")
  set(stated_roslaunch_INSTALL_PREFIX /home/handsome/ros_ws_test/install/stated_roslaunch)
  set(stated_roslaunch_PREFIX ${stated_roslaunch_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'stated_roslaunch' is deprecated")
...
set(stated_roslaunch_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(stated_roslaunch_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Chiu Handsome <chiuhandsome1966@gnail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${stated_roslaunch_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'stated_roslaunch' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'stated_roslaunch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/stated_roslaunch/${idir}'.  ${_report}")
    endif()
    _list_append_unique(stated_roslaunch_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND stated_roslaunch_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND stated_roslaunch_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT stated_roslaunch_NUM_DUMMY_TARGETS)
      set(stated_roslaunch_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::stated_roslaunch::wrapped-linker-option${stated_roslaunch_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR stated_roslaunch_NUM_DUMMY_TARGETS "${stated_roslaunch_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::stated_roslaunch::wrapped-linker-option${stated_roslaunch_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND stated_roslaunch_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(stated_roslaunch_LIBRARY_DIRS ${lib_path})
      list(APPEND stated_roslaunch_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'stated_roslaunch'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND stated_roslaunch_LIBRARIES ${lib})
    endif()
  endif()
...
set(stated_roslaunch_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${stated_roslaunch_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 stated_roslaunch_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${stated_roslaunch_dep}_FOUND)
      find_package(${stated_roslaunch_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${stated_roslaunch_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(stated_roslaunch_INCLUDE_DIRS ${${stated_roslaunch_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(stated_roslaunch_LIBRARIES ${stated_roslaunch_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${stated_roslaunch_dep}_LIBRARIES})
  _list_append_deduplicate(stated_roslaunch_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(stated_roslaunch_LIBRARIES ${stated_roslaunch_LIBRARIES})

  _list_append_unique(stated_roslaunch_LIBRARY_DIRS ${${stated_roslaunch_dep}_LIBRARY_DIRS})
  list(APPEND stated_roslaunch_EXPORTED_TARGETS ${${stated_roslaunch_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${stated_roslaunch_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
