...
"""autogenerated by genpy from open_auto_dock_msgs/UndockActionResult.msg. Do not edit."""
import sys
...
class UndockActionResult(genpy.Message):
  _md5sum = "6868978f7aa1c3f7fba76547d2092ae9"
  _type = "open_auto_dock_msgs/UndockActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','open_auto_dock_msgs/UndockResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UndockActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = open_auto_dock_msgs.msg.UndockResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = open_auto_dock_msgs.msg.UndockResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.undocked,) = _get_struct_B().unpack(str[start:end])
      self.result.undocked = bool(self.result.undocked)
      return self
