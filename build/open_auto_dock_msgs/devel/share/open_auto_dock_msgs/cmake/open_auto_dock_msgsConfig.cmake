...
if(open_auto_dock_msgs_CONFIG_INCLUDED)
  return()
endif()
set(open_auto_dock_msgs_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(open_auto_dock_msgs_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/open_auto_dock/open_auto_dock_msgs)
  set(open_auto_dock_msgs_DEVEL_PREFIX /home/handsome/ros_ws_test/build/open_auto_dock_msgs/devel)
  set(open_auto_dock_msgs_INSTALL_PREFIX "")
  set(open_auto_dock_msgs_PREFIX ${open_auto_dock_msgs_DEVEL_PREFIX})
else()
  set(open_auto_dock_msgs_SOURCE_PREFIX "")
  set(open_auto_dock_msgs_DEVEL_PREFIX "")
  set(open_auto_dock_msgs_INSTALL_PREFIX /home/handsome/ros_ws_test/install/open_auto_dock_msgs)
  set(open_auto_dock_msgs_PREFIX ${open_auto_dock_msgs_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'open_auto_dock_msgs' is deprecated")
...
set(open_auto_dock_msgs_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/handsome/ros_ws_test/build/open_auto_dock_msgs/devel/include " STREQUAL " ")
  set(open_auto_dock_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/build/open_auto_dock_msgs/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://wiki.ros.org/fetch_auto_dock_msgs " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/fetch_auto_dock_msgs' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${open_auto_dock_msgs_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'open_auto_dock_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'open_auto_dock_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/open_auto_dock/open_auto_dock_msgs/${idir}'.  ${_report}")
    endif()
    _list_append_unique(open_auto_dock_msgs_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND open_auto_dock_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND open_auto_dock_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT open_auto_dock_msgs_NUM_DUMMY_TARGETS)
      set(open_auto_dock_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::open_auto_dock_msgs::wrapped-linker-option${open_auto_dock_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR open_auto_dock_msgs_NUM_DUMMY_TARGETS "${open_auto_dock_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::open_auto_dock_msgs::wrapped-linker-option${open_auto_dock_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND open_auto_dock_msgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(open_auto_dock_msgs_LIBRARY_DIRS ${lib_path})
      list(APPEND open_auto_dock_msgs_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'open_auto_dock_msgs'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND open_auto_dock_msgs_LIBRARIES ${lib})
    endif()
  endif()
...
set(open_auto_dock_msgs_EXPORTED_TARGETS "open_auto_dock_msgs_generate_messages_cpp;open_auto_dock_msgs_generate_messages_eus;open_auto_dock_msgs_generate_messages_lisp;open_auto_dock_msgs_generate_messages_nodejs;open_auto_dock_msgs_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${open_auto_dock_msgs_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 open_auto_dock_msgs_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${open_auto_dock_msgs_dep}_FOUND)
      find_package(${open_auto_dock_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${open_auto_dock_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(open_auto_dock_msgs_INCLUDE_DIRS ${${open_auto_dock_msgs_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(open_auto_dock_msgs_LIBRARIES ${open_auto_dock_msgs_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${open_auto_dock_msgs_dep}_LIBRARIES})
  _list_append_deduplicate(open_auto_dock_msgs_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(open_auto_dock_msgs_LIBRARIES ${open_auto_dock_msgs_LIBRARIES})

  _list_append_unique(open_auto_dock_msgs_LIBRARY_DIRS ${${open_auto_dock_msgs_dep}_LIBRARY_DIRS})
  list(APPEND open_auto_dock_msgs_EXPORTED_TARGETS ${${open_auto_dock_msgs_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "open_auto_dock_msgs-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${open_auto_dock_msgs_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
