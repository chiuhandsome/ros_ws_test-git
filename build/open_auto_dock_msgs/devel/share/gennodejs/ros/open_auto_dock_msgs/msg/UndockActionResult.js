...
class UndockActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = UndockResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UndockActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = UndockResult.Resolve(msg.result)
    }
    else {
      resolved.result = new UndockResult()
    }
...
module.exports = UndockActionResult;
