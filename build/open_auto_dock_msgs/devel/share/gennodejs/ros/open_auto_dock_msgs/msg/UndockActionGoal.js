...
class UndockActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = UndockGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UndockActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = UndockGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new UndockGoal()
    }
...
module.exports = UndockActionGoal;
