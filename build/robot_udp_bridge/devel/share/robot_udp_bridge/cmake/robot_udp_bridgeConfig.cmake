...
if(robot_udp_bridge_CONFIG_INCLUDED)
  return()
endif()
set(robot_udp_bridge_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(robot_udp_bridge_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/robot_control_manager/robot_udp_bridge)
  set(robot_udp_bridge_DEVEL_PREFIX /home/handsome/ros_ws_test/build/robot_udp_bridge/devel)
  set(robot_udp_bridge_INSTALL_PREFIX "")
  set(robot_udp_bridge_PREFIX ${robot_udp_bridge_DEVEL_PREFIX})
else()
  set(robot_udp_bridge_SOURCE_PREFIX "")
  set(robot_udp_bridge_DEVEL_PREFIX "")
  set(robot_udp_bridge_INSTALL_PREFIX /home/handsome/ros_ws_test/install/robot_udp_bridge)
  set(robot_udp_bridge_PREFIX ${robot_udp_bridge_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'robot_udp_bridge' is deprecated")
...
set(robot_udp_bridge_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/handsome/ros_ws_test/src/ros_base/robot_control_manager/robot_udp_bridge/include " STREQUAL " ")
  set(robot_udp_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/src/ros_base/robot_control_manager/robot_udp_bridge/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${robot_udp_bridge_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_udp_bridge' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_udp_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/robot_control_manager/robot_udp_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(robot_udp_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "robot_udp_bridge")
foreach(library ${libraries})
  # keep build configuration keywords, target names and absolute libraries as-is
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND robot_udp_bridge_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND robot_udp_bridge_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT robot_udp_bridge_NUM_DUMMY_TARGETS)
      set(robot_udp_bridge_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robot_udp_bridge::wrapped-linker-option${robot_udp_bridge_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robot_udp_bridge_NUM_DUMMY_TARGETS "${robot_udp_bridge_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robot_udp_bridge::wrapped-linker-option${robot_udp_bridge_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robot_udp_bridge_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(robot_udp_bridge_LIBRARY_DIRS ${lib_path})
      list(APPEND robot_udp_bridge_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'robot_udp_bridge'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND robot_udp_bridge_LIBRARIES ${lib})
    endif()
  endif()
...
set(robot_udp_bridge_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${robot_udp_bridge_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "tf;roscpp;roslib;actionlib;rospy;std_msgs;samsungcmd_msgs;botcmd_msgs;mongodb_store_msgs;mongodb_store;ros_utility_tools;robot_control_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 robot_udp_bridge_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${robot_udp_bridge_dep}_FOUND)
      find_package(${robot_udp_bridge_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robot_udp_bridge_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(robot_udp_bridge_INCLUDE_DIRS ${${robot_udp_bridge_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(robot_udp_bridge_LIBRARIES ${robot_udp_bridge_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${robot_udp_bridge_dep}_LIBRARIES})
  _list_append_deduplicate(robot_udp_bridge_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(robot_udp_bridge_LIBRARIES ${robot_udp_bridge_LIBRARIES})

  _list_append_unique(robot_udp_bridge_LIBRARY_DIRS ${${robot_udp_bridge_dep}_LIBRARY_DIRS})
  list(APPEND robot_udp_bridge_EXPORTED_TARGETS ${${robot_udp_bridge_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${robot_udp_bridge_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
