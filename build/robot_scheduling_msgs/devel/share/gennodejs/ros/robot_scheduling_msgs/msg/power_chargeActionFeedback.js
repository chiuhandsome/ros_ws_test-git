...
class power_chargeActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new power_chargeFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = power_chargeFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new power_chargeActionFeedback(null);
    ...
    data.feedback = power_chargeFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new power_chargeActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = power_chargeFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new power_chargeFeedback()
    }
...
module.exports = power_chargeActionFeedback;
