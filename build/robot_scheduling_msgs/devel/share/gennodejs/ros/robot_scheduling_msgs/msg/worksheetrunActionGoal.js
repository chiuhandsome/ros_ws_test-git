...
class worksheetrunActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new worksheetrunGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = worksheetrunGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += worksheetrunGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new worksheetrunActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = worksheetrunGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new worksheetrunGoal()
    }
...
module.exports = worksheetrunActionGoal;
