...
class time_waitActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = time_waitGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += time_waitGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new time_waitActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = time_waitGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new time_waitGoal()
    }
...
module.exports = time_waitActionGoal;
