...
class db_processActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = db_processGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += db_processGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new db_processActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = db_processGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new db_processGoal()
    }
...
module.exports = db_processActionGoal;
