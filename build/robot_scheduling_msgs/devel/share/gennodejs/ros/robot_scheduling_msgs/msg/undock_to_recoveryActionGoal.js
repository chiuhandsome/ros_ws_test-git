...
class undock_to_recoveryActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new undock_to_recoveryGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = undock_to_recoveryGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new undock_to_recoveryActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = undock_to_recoveryGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new undock_to_recoveryActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = undock_to_recoveryGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new undock_to_recoveryGoal()
    }
...
module.exports = undock_to_recoveryActionGoal;
