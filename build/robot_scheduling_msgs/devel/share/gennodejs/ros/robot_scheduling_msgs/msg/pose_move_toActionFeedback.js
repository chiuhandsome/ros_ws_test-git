...
class pose_move_toActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new pose_move_toFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = pose_move_toFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new pose_move_toActionFeedback(null);
    ...
    data.feedback = pose_move_toFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += pose_move_toFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new pose_move_toActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = pose_move_toFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new pose_move_toFeedback()
    }
...
module.exports = pose_move_toActionFeedback;
