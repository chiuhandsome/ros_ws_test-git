...
class robot_interface_proc_lowerResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robot_interface_proc_lowerResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_interface_proc_lowerResult(null);
...
robot_interface_proc_lowerResult.Constants = {
  OK: 1,
  NOT_OK: 2,
  TIMED_OUT: 3,
  OUT_OF_TIMES: 4,
...
module.exports = robot_interface_proc_lowerResult;
