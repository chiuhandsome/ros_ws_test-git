...
class robot_interface_proc_lowerGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robot_interface_proc_lowerGoal(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_interface_proc_lowerGoal(null);
...
robot_interface_proc_lowerGoal.Constants = {
  GET_STATUS: 1,
  SET_COMMAND: 2,
  STATUS: 1,
  BASE_CONNECT: 2,
...
module.exports = robot_interface_proc_lowerGoal;
