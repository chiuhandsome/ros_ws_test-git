...
class pose_move_toActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new pose_move_toGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = pose_move_toGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += pose_move_toGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new pose_move_toActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = pose_move_toGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new pose_move_toGoal()
    }
...
module.exports = pose_move_toActionGoal;
