...
class worksheetrunActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new worksheetrunFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = worksheetrunFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new worksheetrunActionFeedback(null);
    ...
    data.feedback = worksheetrunFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new worksheetrunActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = worksheetrunFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new worksheetrunFeedback()
    }
...
module.exports = worksheetrunActionFeedback;
