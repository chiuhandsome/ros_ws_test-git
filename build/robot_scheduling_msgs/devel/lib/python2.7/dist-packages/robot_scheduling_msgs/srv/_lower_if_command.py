...
"""autogenerated by genpy from robot_scheduling_msgs/lower_if_commandRequest.msg. Do not edit."""
import sys
...
class lower_if_commandRequest(genpy.Message):
  _md5sum = "2e6e7b9d944e8b26071ae1c34c433441"
  _type = "robot_scheduling_msgs/lower_if_commandRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(lower_if_commandRequest, self).__init__(*args, **kwds)
...
def _get_struct_2B():
    ...
    return _struct_2B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robot_scheduling_msgs/lower_if_commandResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class lower_if_commandResponse(genpy.Message):
  _md5sum = "6a0189a3df6e9b1777ecbbecbc6f0332"
  _type = "robot_scheduling_msgs/lower_if_commandResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(lower_if_commandResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_2B():
    ...
    if _struct_2B is None:
        _struct_2B = struct.Struct("<2B")
    return _struct_2B
class lower_if_command(object):
  _type          = 'robot_scheduling_msgs/lower_if_command'
  _md5sum = '441a58e5dfae63962fb07d2ec8a5ac33'
  _request_class  = lower_if_commandRequest
  _response_class = lower_if_commandResponse
