...
"""autogenerated by genpy from robot_scheduling_msgs/time_waitActionResult.msg. Do not edit."""
import sys
...
class time_waitActionResult(genpy.Message):
  _md5sum = "1b9ad2c47a06ed4bb56528585061ce51"
  _type = "robot_scheduling_msgs/time_waitActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/time_waitResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(time_waitActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_scheduling_msgs.msg.time_waitResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_scheduling_msgs.msg.time_waitResult()
