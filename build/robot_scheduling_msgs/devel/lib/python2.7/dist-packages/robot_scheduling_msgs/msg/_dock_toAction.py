...
"""autogenerated by genpy from robot_scheduling_msgs/dock_toAction.msg. Do not edit."""
import sys
...
class dock_toAction(genpy.Message):
  _md5sum = "8461b4d33983a2b57381dbc17d56a313"
  _type = "robot_scheduling_msgs/dock_toAction"
...
"""
  ...
  _slot_types = ['robot_scheduling_msgs/dock_toActionGoal','robot_scheduling_msgs/dock_toActionResult','robot_scheduling_msgs/dock_toActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(dock_toAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = robot_scheduling_msgs.msg.dock_toActionGoal()
      if self.action_result is None:
        self.action_result = robot_scheduling_msgs.msg.dock_toActionResult()
      if self.action_feedback is None:
        self.action_feedback = robot_scheduling_msgs.msg.dock_toActionFeedback()
    else:
      self.action_goal = robot_scheduling_msgs.msg.dock_toActionGoal()
      self.action_result = robot_scheduling_msgs.msg.dock_toActionResult()
      self.action_feedback = robot_scheduling_msgs.msg.dock_toActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.pre_dock_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      _x = self.action_goal.goal.dock_ac_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_feedback.feedback.docked
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.pre_dock_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.pre_dock_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.dock_ac_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.dock_ac_name = str[start:end]
      _x = self
      start = end
      end += 13
      ...
      (self.action_feedback.feedback.docked,) = _get_struct_B().unpack(str[start:end])
