...
"""autogenerated by genpy from robot_scheduling_msgs/power_chargeActionFeedback.msg. Do not edit."""
import sys
...
class power_chargeActionFeedback(genpy.Message):
  _md5sum = "85e6d5f508b793492f87728c74c18170"
  _type = "robot_scheduling_msgs/power_chargeActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/power_chargeFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(power_chargeActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = robot_scheduling_msgs.msg.power_chargeFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robot_scheduling_msgs.msg.power_chargeFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.feedback.charge_fb_state
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.charge_fb_state,) = _get_struct_B().unpack(str[start:end])
      return self
