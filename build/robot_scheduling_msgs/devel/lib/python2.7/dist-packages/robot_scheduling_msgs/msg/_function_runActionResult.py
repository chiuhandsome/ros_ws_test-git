...
"""autogenerated by genpy from robot_scheduling_msgs/function_runActionResult.msg. Do not edit."""
import sys
...
class function_runActionResult(genpy.Message):
  _md5sum = "e32e1fdd64584a759542890d3f111607"
  _type = "robot_scheduling_msgs/function_runActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/function_runResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(function_runActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_scheduling_msgs.msg.function_runResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_scheduling_msgs.msg.function_runResult()
