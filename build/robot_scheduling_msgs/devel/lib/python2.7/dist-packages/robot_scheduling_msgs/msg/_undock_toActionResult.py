...
"""autogenerated by genpy from robot_scheduling_msgs/undock_toActionResult.msg. Do not edit."""
import sys
...
class undock_toActionResult(genpy.Message):
  _md5sum = "59c1e93b1604aee89b49d2bc45896682"
  _type = "robot_scheduling_msgs/undock_toActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/undock_toResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(undock_toActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_scheduling_msgs.msg.undock_toResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_scheduling_msgs.msg.undock_toResult()
