...
"""autogenerated by genpy from robot_scheduling_msgs/self_turn_toActionResult.msg. Do not edit."""
import sys
...
class self_turn_toActionResult(genpy.Message):
  _md5sum = "b4df2b621988c419ff2b1b3d35c9a926"
  _type = "robot_scheduling_msgs/self_turn_toActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/self_turn_toResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(self_turn_toActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_scheduling_msgs.msg.self_turn_toResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_scheduling_msgs.msg.self_turn_toResult()
