...
"""autogenerated by genpy from robot_scheduling_msgs/time_waitActionFeedback.msg. Do not edit."""
import sys
...
class time_waitActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "robot_scheduling_msgs/time_waitActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/time_waitFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(time_waitActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = robot_scheduling_msgs.msg.time_waitFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robot_scheduling_msgs.msg.time_waitFeedback()
