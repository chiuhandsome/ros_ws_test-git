...
"""autogenerated by genpy from robot_scheduling_msgs/pose_move_toActionResult.msg. Do not edit."""
import sys
...
class pose_move_toActionResult(genpy.Message):
  _md5sum = "bf160040aee704affe04954868927fad"
  _type = "robot_scheduling_msgs/pose_move_toActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/pose_move_toResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(pose_move_toActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_scheduling_msgs.msg.pose_move_toResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_scheduling_msgs.msg.pose_move_toResult()
