...
"""autogenerated by genpy from robot_scheduling_msgs/pose_move_toAction.msg. Do not edit."""
import sys
...
class pose_move_toAction(genpy.Message):
  _md5sum = "054099a1c0e62ec7064758334100da89"
  _type = "robot_scheduling_msgs/pose_move_toAction"
...
"""
  ...
  _slot_types = ['robot_scheduling_msgs/pose_move_toActionGoal','robot_scheduling_msgs/pose_move_toActionResult','robot_scheduling_msgs/pose_move_toActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(pose_move_toAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = robot_scheduling_msgs.msg.pose_move_toActionGoal()
      if self.action_result is None:
        self.action_result = robot_scheduling_msgs.msg.pose_move_toActionResult()
      if self.action_feedback is None:
        self.action_feedback = robot_scheduling_msgs.msg.pose_move_toActionFeedback()
    else:
      self.action_goal = robot_scheduling_msgs.msg.pose_move_toActionGoal()
      self.action_result = robot_scheduling_msgs.msg.pose_move_toActionResult()
      self.action_feedback = robot_scheduling_msgs.msg.pose_move_toActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.action_goal.goal.move_ac_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.pose_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.move_ac_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.move_ac_name = str[start:end]
      _x = self
      start = end
      end += 12
