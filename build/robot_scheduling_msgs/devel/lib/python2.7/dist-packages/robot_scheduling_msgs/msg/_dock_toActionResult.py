...
"""autogenerated by genpy from robot_scheduling_msgs/dock_toActionResult.msg. Do not edit."""
import sys
...
class dock_toActionResult(genpy.Message):
  _md5sum = "0493652b89c96712ec7862bd52ac39b2"
  _type = "robot_scheduling_msgs/dock_toActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/dock_toResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(dock_toActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_scheduling_msgs.msg.dock_toResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_scheduling_msgs.msg.dock_toResult()
