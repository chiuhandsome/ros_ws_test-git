...
let FetchBoxGoal = require('./FetchBoxGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FetchBoxActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FetchBoxGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FetchBoxActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FetchBoxGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FetchBoxGoal()
    }
...
module.exports = FetchBoxActionGoal;
