...
if(tug_example_msgs_CONFIG_INCLUDED)
  return()
endif()
set(tug_example_msgs_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(tug_example_msgs_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/PNPros/example/tug_example_msgs)
  set(tug_example_msgs_DEVEL_PREFIX /home/handsome/ros_ws_test/build/tug_example_msgs/devel)
  set(tug_example_msgs_INSTALL_PREFIX "")
  set(tug_example_msgs_PREFIX ${tug_example_msgs_DEVEL_PREFIX})
else()
  set(tug_example_msgs_SOURCE_PREFIX "")
  set(tug_example_msgs_DEVEL_PREFIX "")
  set(tug_example_msgs_INSTALL_PREFIX /home/handsome/ros_ws_test/install/tug_example_msgs)
  set(tug_example_msgs_PREFIX ${tug_example_msgs_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'tug_example_msgs' is deprecated")
...
set(tug_example_msgs_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/handsome/ros_ws_test/build/tug_example_msgs/devel/include " STREQUAL " ")
  set(tug_example_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/build/tug_example_msgs/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${tug_example_msgs_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tug_example_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'tug_example_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/PNPros/example/tug_example_msgs/${idir}'.  ${_report}")
    endif()
    _list_append_unique(tug_example_msgs_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND tug_example_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND tug_example_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT tug_example_msgs_NUM_DUMMY_TARGETS)
      set(tug_example_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::tug_example_msgs::wrapped-linker-option${tug_example_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR tug_example_msgs_NUM_DUMMY_TARGETS "${tug_example_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::tug_example_msgs::wrapped-linker-option${tug_example_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND tug_example_msgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(tug_example_msgs_LIBRARY_DIRS ${lib_path})
      list(APPEND tug_example_msgs_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'tug_example_msgs'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND tug_example_msgs_LIBRARIES ${lib})
    endif()
  endif()
...
set(tug_example_msgs_EXPORTED_TARGETS "tug_example_msgs_generate_messages_cpp;tug_example_msgs_generate_messages_eus;tug_example_msgs_generate_messages_lisp;tug_example_msgs_generate_messages_nodejs;tug_example_msgs_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${tug_example_msgs_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 tug_example_msgs_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${tug_example_msgs_dep}_FOUND)
      find_package(${tug_example_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tug_example_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(tug_example_msgs_INCLUDE_DIRS ${${tug_example_msgs_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(tug_example_msgs_LIBRARIES ${tug_example_msgs_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${tug_example_msgs_dep}_LIBRARIES})
  _list_append_deduplicate(tug_example_msgs_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(tug_example_msgs_LIBRARIES ${tug_example_msgs_LIBRARIES})

  _list_append_unique(tug_example_msgs_LIBRARY_DIRS ${${tug_example_msgs_dep}_LIBRARY_DIRS})
  list(APPEND tug_example_msgs_EXPORTED_TARGETS ${${tug_example_msgs_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "tug_example_msgs-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${tug_example_msgs_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
