...
"""autogenerated by genpy from tug_example_msgs/RecoverTimedOutActionResult.msg. Do not edit."""
import sys
...
class RecoverTimedOutActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "tug_example_msgs/RecoverTimedOutActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tug_example_msgs/RecoverTimedOutResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RecoverTimedOutActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tug_example_msgs.msg.RecoverTimedOutResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tug_example_msgs.msg.RecoverTimedOutResult()
