...
"""autogenerated by genpy from tug_example_msgs/TransportBoxActionResult.msg. Do not edit."""
import sys
...
class TransportBoxActionResult(genpy.Message):
  _md5sum = "8b74209535e99df65b476df1512f7f83"
  _type = "tug_example_msgs/TransportBoxActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tug_example_msgs/TransportBoxResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TransportBoxActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tug_example_msgs.msg.TransportBoxResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tug_example_msgs.msg.TransportBoxResult()
