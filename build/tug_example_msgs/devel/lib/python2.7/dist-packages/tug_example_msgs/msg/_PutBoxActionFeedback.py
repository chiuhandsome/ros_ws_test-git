...
"""autogenerated by genpy from tug_example_msgs/PutBoxActionFeedback.msg. Do not edit."""
import sys
...
class PutBoxActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "tug_example_msgs/PutBoxActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tug_example_msgs/PutBoxFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PutBoxActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = tug_example_msgs.msg.PutBoxFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = tug_example_msgs.msg.PutBoxFeedback()
