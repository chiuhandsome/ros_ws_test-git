...
if(pnp_rosplan_CONFIG_INCLUDED)
  return()
endif()
set(pnp_rosplan_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(pnp_rosplan_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/PNPros/ROS_bridge/pnp_rosplan)
  set(pnp_rosplan_DEVEL_PREFIX /home/handsome/ros_ws_test/build/pnp_rosplan/devel)
  set(pnp_rosplan_INSTALL_PREFIX "")
  set(pnp_rosplan_PREFIX ${pnp_rosplan_DEVEL_PREFIX})
else()
  set(pnp_rosplan_SOURCE_PREFIX "")
  set(pnp_rosplan_DEVEL_PREFIX "")
  set(pnp_rosplan_INSTALL_PREFIX /home/handsome/ros_ws_test/install/pnp_rosplan)
  set(pnp_rosplan_PREFIX ${pnp_rosplan_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'pnp_rosplan' is deprecated")
...
set(pnp_rosplan_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(pnp_rosplan_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${pnp_rosplan_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pnp_rosplan' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pnp_rosplan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/PNPros/ROS_bridge/pnp_rosplan/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pnp_rosplan_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND pnp_rosplan_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND pnp_rosplan_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT pnp_rosplan_NUM_DUMMY_TARGETS)
      set(pnp_rosplan_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pnp_rosplan::wrapped-linker-option${pnp_rosplan_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pnp_rosplan_NUM_DUMMY_TARGETS "${pnp_rosplan_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pnp_rosplan::wrapped-linker-option${pnp_rosplan_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pnp_rosplan_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(pnp_rosplan_LIBRARY_DIRS ${lib_path})
      list(APPEND pnp_rosplan_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'pnp_rosplan'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND pnp_rosplan_LIBRARIES ${lib})
    endif()
  endif()
...
set(pnp_rosplan_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${pnp_rosplan_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "pnp_ros;roscpp;rospy;std_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 pnp_rosplan_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${pnp_rosplan_dep}_FOUND)
      find_package(${pnp_rosplan_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pnp_rosplan_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(pnp_rosplan_INCLUDE_DIRS ${${pnp_rosplan_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(pnp_rosplan_LIBRARIES ${pnp_rosplan_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${pnp_rosplan_dep}_LIBRARIES})
  _list_append_deduplicate(pnp_rosplan_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(pnp_rosplan_LIBRARIES ${pnp_rosplan_LIBRARIES})

  _list_append_unique(pnp_rosplan_LIBRARY_DIRS ${${pnp_rosplan_dep}_LIBRARY_DIRS})
  list(APPEND pnp_rosplan_EXPORTED_TARGETS ${${pnp_rosplan_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${pnp_rosplan_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
