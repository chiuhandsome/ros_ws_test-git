...
"""autogenerated by genpy from rp_action_msgs/TurnAction.msg. Do not edit."""
import sys
...
import genpy
import rp_action_msgs.msg
import std_msgs.msg

class TurnAction(genpy.Message):
  _md5sum = "e7a9eb154ca53d81e0794f4c0d2487ba"
  _type = "rp_action_msgs/TurnAction"
...
"""
  ...
  _slot_types = ['rp_action_msgs/TurnActionGoal','rp_action_msgs/TurnActionResult','rp_action_msgs/TurnActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = rp_action_msgs.msg.TurnActionGoal()
      if self.action_result is None:
        self.action_result = rp_action_msgs.msg.TurnActionResult()
      if self.action_feedback is None:
        self.action_feedback = rp_action_msgs.msg.TurnActionFeedback()
    else:
      self.action_goal = rp_action_msgs.msg.TurnActionGoal()
      self.action_result = rp_action_msgs.msg.TurnActionResult()
      self.action_feedback = rp_action_msgs.msg.TurnActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.max_ang_vel
      buff.write(_get_struct_f().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.max_ang_vel,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
