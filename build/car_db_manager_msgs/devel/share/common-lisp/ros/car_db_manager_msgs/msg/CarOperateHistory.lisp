...
;//! \htmlinclude CarOperateHistory.msg.html

(cl:defclass <CarOperateHistory> (roslisp-msg-protocol:ros-message)
  ((primary_id
    :reader primary_id
    :initarg :primary_id
    :type cl:string
...
(cl:defclass CarOperateHistory (<CarOperateHistory>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <CarOperateHistory>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'CarOperateHistory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_db_manager_msgs-msg:<CarOperateHistory> is deprecated: use car_db_manager_msgs-msg:CarOperateHistory instead.")))

(cl:ensure-generic-function 'primary_id-val :lambda-list '(m))
(cl:defmethod primary_id-val ((m <CarOperateHistory>))
...
(cl:defmethod unique_code-val ((m <CarOperateHistory>))
...
(cl:defmethod base_name-val ((m <CarOperateHistory>))
...
(cl:defmethod occur_time-val ((m <CarOperateHistory>))
...
(cl:defmethod alarm_remark-val ((m <CarOperateHistory>))
...
(cl:defmethod update_time-val ((m <CarOperateHistory>))
  ...
  (update_time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <CarOperateHistory>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CarOperateHistory>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CarOperateHistory>)))
  "Returns string type for a message object of type '<CarOperateHistory>"
  "car_db_manager_msgs/CarOperateHistory")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CarOperateHistory)))
  "Returns string type for a message object of type 'CarOperateHistory"
  "car_db_manager_msgs/CarOperateHistory")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CarOperateHistory>)))
  "Returns md5sum for a message object of type '<CarOperateHistory>"
  "c3b5f21ce52ec5f142f795740d19d92b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CarOperateHistory)))
  "Returns md5sum for a message object of type 'CarOperateHistory"
  "c3b5f21ce52ec5f142f795740d19d92b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CarOperateHistory>)))
  "Returns full string definition for message of type '<CarOperateHistory>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CarOperateHistory)))
  "Returns full string definition for message of type 'CarOperateHistory"
  (cl:format cl:nil "string primary_id			# must-have,UUID : primary_key(system_id)		~%string unique_code 		        # must-have,UNIQUE INDEX , parameter_id	~%string base_name~%string occur_time~%string alarm_remark~%string update_time			# must-have 	 ~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <CarOperateHistory>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <CarOperateHistory>))
  "Converts a ROS message object to a list"
  (cl:list 'CarOperateHistory
