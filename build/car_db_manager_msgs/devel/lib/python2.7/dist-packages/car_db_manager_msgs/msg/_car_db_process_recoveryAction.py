...
"""autogenerated by genpy from car_db_manager_msgs/car_db_process_recoveryAction.msg. Do not edit."""
import sys
...
class car_db_process_recoveryAction(genpy.Message):
  _md5sum = "35d902903f56e4f99d10cce69346f67b"
  _type = "car_db_manager_msgs/car_db_process_recoveryAction"
...
"""
  ...
  _slot_types = ['car_db_manager_msgs/car_db_process_recoveryActionGoal','car_db_manager_msgs/car_db_process_recoveryActionResult','car_db_manager_msgs/car_db_process_recoveryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(car_db_process_recoveryAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = car_db_manager_msgs.msg.car_db_process_recoveryActionGoal()
      if self.action_result is None:
        self.action_result = car_db_manager_msgs.msg.car_db_process_recoveryActionResult()
      if self.action_feedback is None:
        self.action_feedback = car_db_manager_msgs.msg.car_db_process_recoveryActionFeedback()
    else:
      self.action_goal = car_db_manager_msgs.msg.car_db_process_recoveryActionGoal()
      self.action_result = car_db_manager_msgs.msg.car_db_process_recoveryActionResult()
      self.action_feedback = car_db_manager_msgs.msg.car_db_process_recoveryActionFeedback()
