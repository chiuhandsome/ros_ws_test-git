...
set(MSG_I_FLAGS "-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Idynamic_reconfigure:/opt/ros/melodic/share/dynamic_reconfigure/cmake/../msg")
...
get_filename_component(_filename "/home/handsome/ros_ws_test/src/ros_base/spatio_temporal_voxel_layer/msgs/SaveGrid.srv" NAME_WE)
add_custom_target(_spatio_temporal_voxel_layer_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "spatio_temporal_voxel_layer" "/home/handsome/ros_ws_test/src/ros_base/spatio_temporal_voxel_layer/msgs/SaveGrid.srv" "std_msgs/String"
)
...
_generate_srv_cpp(spatio_temporal_voxel_layer
  "/home/handsome/ros_ws_test/src/ros_base/spatio_temporal_voxel_layer/msgs/SaveGrid.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/spatio_temporal_voxel_layer)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/spatio_temporal_voxel_layer\")")
  # install generated code
  install(
