...
public:
    ...
    void setupUi(QWidget *frmDB_baseTable)
    {
        ...
        cbox_sort_code = new QCheckBox(layoutWidget);
        ...
        cbox_sort_time = new QCheckBox(layoutWidget);
        ...
        widget = new QWidget(frmDB_baseTable);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(410, 20, 441, 641));
        ...
        op_frame = new QFrame(widget);
        op_frame->setObjectName(QStringLiteral("op_frame"));
        op_frame->setGeometry(QRect(10, 472, 225, 80));
...
"color: fuchsia;"));
        ...
        lineEdit_0 = new QLineEdit(widget1);
        ...
        lb_field_9 = new QLabel(widget1);
        lb_field_9->setObjectName(QStringLiteral("lb_field_9"));
        lb_field_9->setFont(font);
        lb_field_9->setStyleSheet(QStringLiteral("color: blue;"));

        horizontalLayout_9->addWidget(lb_field_9);
        ...
        lb_field_10 = new QLabel(widget1);
        lb_field_10->setObjectName(QStringLiteral("lb_field_10"));
        lb_field_10->setFont(font);
        lb_field_10->setStyleSheet(QStringLiteral("color: blue;"));

        horizontalLayout_10->addWidget(lb_field_10);
        ...
        lb_field_11 = new QLabel(widget1);
        lb_field_11->setObjectName(QStringLiteral("lb_field_11"));
        lb_field_11->setFont(font);
        lb_field_11->setStyleSheet(QStringLiteral("color: blue;"));

        horizontalLayout_11->addWidget(lb_field_11);
        ...
        close_frame = new QFrame(widget);
        close_frame->setObjectName(QStringLiteral("close_frame"));
        close_frame->setGeometry(QRect(320, 473, 112, 80));
...
"color: fuchsia;"));
        ...
        lb_table_edittype = new QLabel(widget);
        ...
        choice_frame = new QFrame(widget);
        choice_frame->setObjectName(QStringLiteral("choice_frame"));
        choice_frame->setGeometry(QRect(320, 473, 112, 80));
...
"color: blue;"));
        ...
        search_frame = new QFrame(widget);
        search_frame->setObjectName(QStringLiteral("search_frame"));
        search_frame->setGeometry(QRect(10, 473, 421, 161));
...
"color: blue;"));
    ...
    void retranslateUi(QWidget *frmDB_baseTable)
    {
        ...
        lb_field_9->setText(QApplication::translate("frmDB_baseTable", "primary_id", Q_NULLPTR));
        lb_field_10->setText(QApplication::translate("frmDB_baseTable", "primary_id", Q_NULLPTR));
        lb_field_11->setText(QApplication::translate("frmDB_baseTable", "primary_id", Q_NULLPTR));
