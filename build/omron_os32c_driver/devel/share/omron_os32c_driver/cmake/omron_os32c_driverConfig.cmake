...
if("TRUE" STREQUAL "TRUE")
  set(omron_os32c_driver_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/sensor_source/omron/omron_os32c_driver)
  set(omron_os32c_driver_DEVEL_PREFIX /home/handsome/ros_ws_test/build/omron_os32c_driver/devel)
  ...
  set(omron_os32c_driver_INSTALL_PREFIX /home/handsome/ros_ws_test/install/omron_os32c_driver)
...
if(NOT "/home/handsome/ros_ws_test/src/ros_base/sensor_source/omron/omron_os32c_driver/include;/usr/include " STREQUAL " ")
  set(omron_os32c_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/src/ros_base/sensor_source/omron/omron_os32c_driver/include;/usr/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Rein Appeldoorn <rein@ruvu.nl>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'omron_os32c_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/sensor_source/omron/omron_os32c_driver/${idir}'.  ${_report}")
    endif()
...
set(depends "diagnostic_updater;odva_ethernetip;roscpp;sensor_msgs")
