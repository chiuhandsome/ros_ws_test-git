...
"""autogenerated by genpy from botcmd_msgs/actBotCmdActionResult.msg. Do not edit."""
import sys
...
class actBotCmdActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "botcmd_msgs/actBotCmdActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','botcmd_msgs/actBotCmdResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(actBotCmdActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = botcmd_msgs.msg.actBotCmdResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = botcmd_msgs.msg.actBotCmdResult()
