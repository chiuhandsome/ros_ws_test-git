// Generated by gencpp from file botcmd_msgs/bot_transbattery.msg
// DO NOT EDIT!


#ifndef BOTCMD_MSGS_MESSAGE_BOT_TRANSBATTERY_H
#define BOTCMD_MSGS_MESSAGE_BOT_TRANSBATTERY_H
...
struct bot_transbattery_
{
  typedef bot_transbattery_<ContainerAllocator> Type;
  ...
  bot_transbattery_(const ContainerAllocator& _alloc)
    : index_ID(0)
    , gen_alarmcode(0)
    , emg_alarmcode(0)
    , chargstate_code(0)
  ...
  typedef boost::shared_ptr< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> const> ConstPtr;

}; // struct bot_transbattery_

typedef ::botcmd_msgs::bot_transbattery_<std::allocator<void> > bot_transbattery;

typedef boost::shared_ptr< ::botcmd_msgs::bot_transbattery > bot_transbatteryPtr;
typedef boost::shared_ptr< ::botcmd_msgs::bot_transbattery const> bot_transbatteryConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::botcmd_msgs::bot_transbattery_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::botcmd_msgs::bot_transbattery_<ContainerAllocator1> & lhs, const ::botcmd_msgs::bot_transbattery_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> >
{
  ...
  static const char* value(const ::botcmd_msgs::bot_transbattery_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x42a37315d341a8a2ULL;
  static const uint64_t static_value2 = 0x61c4ebe967c4f174ULL;
};

template<class ContainerAllocator>
struct DataType< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::botcmd_msgs::bot_transbattery_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::botcmd_msgs::bot_transbattery_<ContainerAllocator>& v)
  {
    s << indent << "index_ID: ";
...
#endif // BOTCMD_MSGS_MESSAGE_BOT_TRANSBATTERY_H
