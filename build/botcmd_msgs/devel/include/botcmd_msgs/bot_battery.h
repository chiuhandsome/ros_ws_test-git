// Generated by gencpp from file botcmd_msgs/bot_battery.msg
// DO NOT EDIT!


#ifndef BOTCMD_MSGS_MESSAGE_BOT_BATTERY_H
#define BOTCMD_MSGS_MESSAGE_BOT_BATTERY_H
...
struct bot_battery_
{
  typedef bot_battery_<ContainerAllocator> Type;
  ...
  bot_battery_(const ContainerAllocator& _alloc)
    : stamp()
    , gen_alarmcode(0)
    , emg_alarmcode(0)
    , chargstate_code(0)
  ...
  typedef boost::shared_ptr< ::botcmd_msgs::bot_battery_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::botcmd_msgs::bot_battery_<ContainerAllocator> const> ConstPtr;

}; // struct bot_battery_

typedef ::botcmd_msgs::bot_battery_<std::allocator<void> > bot_battery;

typedef boost::shared_ptr< ::botcmd_msgs::bot_battery > bot_batteryPtr;
typedef boost::shared_ptr< ::botcmd_msgs::bot_battery const> bot_batteryConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::botcmd_msgs::bot_battery_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::botcmd_msgs::bot_battery_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::botcmd_msgs::bot_battery_<ContainerAllocator1> & lhs, const ::botcmd_msgs::bot_battery_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::botcmd_msgs::bot_battery_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::botcmd_msgs::bot_battery_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::botcmd_msgs::bot_battery_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::botcmd_msgs::bot_battery_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::botcmd_msgs::bot_battery_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::botcmd_msgs::bot_battery_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::botcmd_msgs::bot_battery_<ContainerAllocator> >
{
  ...
  static const char* value(const ::botcmd_msgs::bot_battery_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2025128134cea869ULL;
  static const uint64_t static_value2 = 0x1154663daed5045aULL;
};

template<class ContainerAllocator>
struct DataType< ::botcmd_msgs::bot_battery_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::botcmd_msgs::bot_battery_<ContainerAllocator> >
{
  static const char* value()
  {
    return "time stamp\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::botcmd_msgs::bot_battery_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::botcmd_msgs::bot_battery_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::botcmd_msgs::bot_battery_<ContainerAllocator>& v)
  {
    s << indent << "stamp: ";
...
#endif // BOTCMD_MSGS_MESSAGE_BOT_BATTERY_H
