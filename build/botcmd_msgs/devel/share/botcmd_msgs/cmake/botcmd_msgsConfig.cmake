...
if(botcmd_msgs_CONFIG_INCLUDED)
  return()
endif()
set(botcmd_msgs_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(botcmd_msgs_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/botcmd_msgs )
  set(botcmd_msgs_DEVEL_PREFIX /home/handsome/ros_ws_test/build/botcmd_msgs/devel)
  set(botcmd_msgs_INSTALL_PREFIX "")
  set(botcmd_msgs_PREFIX ${botcmd_msgs_DEVEL_PREFIX})
else()
  set(botcmd_msgs_SOURCE_PREFIX "")
  set(botcmd_msgs_DEVEL_PREFIX "")
  set(botcmd_msgs_INSTALL_PREFIX /home/handsome/ros_ws_test/install/botcmd_msgs)
  set(botcmd_msgs_PREFIX ${botcmd_msgs_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'botcmd_msgs' is deprecated")
...
set(botcmd_msgs_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/handsome/ros_ws_test/build/botcmd_msgs/devel/include " STREQUAL " ")
  set(botcmd_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/build/botcmd_msgs/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${botcmd_msgs_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'botcmd_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'botcmd_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/botcmd_msgs /${idir}'.  ${_report}")
    endif()
    _list_append_unique(botcmd_msgs_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND botcmd_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND botcmd_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT botcmd_msgs_NUM_DUMMY_TARGETS)
      set(botcmd_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::botcmd_msgs::wrapped-linker-option${botcmd_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR botcmd_msgs_NUM_DUMMY_TARGETS "${botcmd_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::botcmd_msgs::wrapped-linker-option${botcmd_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND botcmd_msgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(botcmd_msgs_LIBRARY_DIRS ${lib_path})
      list(APPEND botcmd_msgs_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'botcmd_msgs'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND botcmd_msgs_LIBRARIES ${lib})
    endif()
  endif()
...
set(botcmd_msgs_EXPORTED_TARGETS "botcmd_msgs_generate_messages_cpp;botcmd_msgs_generate_messages_eus;botcmd_msgs_generate_messages_lisp;botcmd_msgs_generate_messages_nodejs;botcmd_msgs_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${botcmd_msgs_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 botcmd_msgs_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${botcmd_msgs_dep}_FOUND)
      find_package(${botcmd_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${botcmd_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(botcmd_msgs_INCLUDE_DIRS ${${botcmd_msgs_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(botcmd_msgs_LIBRARIES ${botcmd_msgs_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${botcmd_msgs_dep}_LIBRARIES})
  _list_append_deduplicate(botcmd_msgs_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(botcmd_msgs_LIBRARIES ${botcmd_msgs_LIBRARIES})

  _list_append_unique(botcmd_msgs_LIBRARY_DIRS ${${botcmd_msgs_dep}_LIBRARY_DIRS})
  list(APPEND botcmd_msgs_EXPORTED_TARGETS ${${botcmd_msgs_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "botcmd_msgs-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${botcmd_msgs_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
