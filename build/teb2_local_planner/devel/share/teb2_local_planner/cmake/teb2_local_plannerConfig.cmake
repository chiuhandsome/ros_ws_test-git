...
if(teb2_local_planner_CONFIG_INCLUDED)
  return()
endif()
set(teb2_local_planner_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(teb2_local_planner_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/teb2_local_planner)
  set(teb2_local_planner_DEVEL_PREFIX /home/handsome/ros_ws_test/build/teb2_local_planner/devel)
  set(teb2_local_planner_INSTALL_PREFIX "")
  set(teb2_local_planner_PREFIX ${teb2_local_planner_DEVEL_PREFIX})
else()
  set(teb2_local_planner_SOURCE_PREFIX "")
  set(teb2_local_planner_DEVEL_PREFIX "")
  set(teb2_local_planner_INSTALL_PREFIX /home/handsome/ros_ws_test/install/teb2_local_planner)
  set(teb2_local_planner_PREFIX ${teb2_local_planner_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'teb2_local_planner' is deprecated")
...
set(teb2_local_planner_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/handsome/ros_ws_test/build/teb2_local_planner/devel/include;/home/handsome/ros_ws_test/src/ros_base/teb2_local_planner/include;/usr/include/suitesparse;/opt/ros/melodic/include/g2o " STREQUAL " ")
  set(teb2_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/build/teb2_local_planner/devel/include;/home/handsome/ros_ws_test/src/ros_base/teb2_local_planner/include;/usr/include/suitesparse;/opt/ros/melodic/include/g2o")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${teb2_local_planner_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'teb2_local_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'teb2_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/teb2_local_planner/${idir}'.  ${_report}")
    endif()
    _list_append_unique(teb2_local_planner_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "teb2_local_planner;amd;btf;camd;ccolamd;cholmod;colamd;cxsparse;klu;umfpack;spqr;/opt/ros/melodic/lib/libg2o_csparse_extension.so;/opt/ros/melodic/lib/libg2o_core.so;/opt/ros/melodic/lib/libg2o_stuff.so;/opt/ros/melodic/lib/libg2o_types_slam2d.so;/opt/ros/melodic/lib/libg2o_types_slam3d.so;/opt/ros/melodic/lib/libg2o_solver_cholmod.so;/opt/ros/melodic/lib/libg2o_solver_pcg.so;/opt/ros/melodic/lib/libg2o_solver_csparse.so;/opt/ros/melodic/lib/libg2o_incremental.so")
foreach(library ${libraries})
  # keep build configuration keywords, target names and absolute libraries as-is
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND teb2_local_planner_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND teb2_local_planner_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT teb2_local_planner_NUM_DUMMY_TARGETS)
      set(teb2_local_planner_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::teb2_local_planner::wrapped-linker-option${teb2_local_planner_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR teb2_local_planner_NUM_DUMMY_TARGETS "${teb2_local_planner_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::teb2_local_planner::wrapped-linker-option${teb2_local_planner_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND teb2_local_planner_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(teb2_local_planner_LIBRARY_DIRS ${lib_path})
      list(APPEND teb2_local_planner_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'teb2_local_planner'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND teb2_local_planner_LIBRARIES ${lib})
    endif()
  endif()
...
set(teb2_local_planner_EXPORTED_TARGETS "teb2_local_planner_generate_messages_cpp;teb2_local_planner_generate_messages_eus;teb2_local_planner_generate_messages_lisp;teb2_local_planner_generate_messages_nodejs;teb2_local_planner_generate_messages_py;teb2_local_planner_gencfg")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${teb2_local_planner_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "costmap_2d;costmap_converter;dynamic_reconfigure;geometry_msgs;interactive_markers;message_runtime;nav_msgs;nav_2d_msgs;nav_2d_utils;nav_core2;nav_core_adapter;pluginlib;roscpp;std_msgs;tf2;tf2_ros;visualization_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 teb2_local_planner_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${teb2_local_planner_dep}_FOUND)
      find_package(${teb2_local_planner_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${teb2_local_planner_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(teb2_local_planner_INCLUDE_DIRS ${${teb2_local_planner_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(teb2_local_planner_LIBRARIES ${teb2_local_planner_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${teb2_local_planner_dep}_LIBRARIES})
  _list_append_deduplicate(teb2_local_planner_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(teb2_local_planner_LIBRARIES ${teb2_local_planner_LIBRARIES})

  _list_append_unique(teb2_local_planner_LIBRARY_DIRS ${${teb2_local_planner_dep}_LIBRARY_DIRS})
  list(APPEND teb2_local_planner_EXPORTED_TARGETS ${${teb2_local_planner_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "teb2_local_planner-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${teb2_local_planner_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
