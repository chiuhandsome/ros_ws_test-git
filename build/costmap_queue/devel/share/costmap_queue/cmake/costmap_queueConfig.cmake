...
if("TRUE" STREQUAL "TRUE")
  set(costmap_queue_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/robot_navigation/costmap_queue)
  set(costmap_queue_DEVEL_PREFIX /home/handsome/ros_ws_test/build/costmap_queue/devel)
  ...
  set(costmap_queue_INSTALL_PREFIX /home/handsome/ros_ws_test/install/costmap_queue)
...
if(NOT "/home/handsome/ros_ws_test/src/ros_base/robot_navigation/costmap_queue/include " STREQUAL " ")
  set(costmap_queue_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/src/ros_base/robot_navigation/costmap_queue/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_queue' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/robot_navigation/costmap_queue/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND costmap_queue_EXPORTED_TARGETS ${${costmap_queue_dep}_EXPORTED_TARGETS})
endforeach()
