...
if("TRUE" STREQUAL "TRUE")
  set(mongodb_store_msgs_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/mongodb_store/mongodb_store_msgs)
  set(mongodb_store_msgs_DEVEL_PREFIX /home/handsome/ros_ws_test/build/mongodb_store_msgs/devel)
  ...
  set(mongodb_store_msgs_INSTALL_PREFIX /home/handsome/ros_ws_test/install/mongodb_store_msgs)
...
if(NOT "/home/handsome/ros_ws_test/build/mongodb_store_msgs/devel/include " STREQUAL " ")
  set(mongodb_store_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/build/mongodb_store_msgs/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mongodb_store_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/mongodb_store/mongodb_store_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mongodb_store_msgs_NUM_DUMMY_TARGETS)
      set(mongodb_store_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mongodb_store_msgs::wrapped-linker-option${mongodb_store_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mongodb_store_msgs_NUM_DUMMY_TARGETS "${mongodb_store_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mongodb_store_msgs::wrapped-linker-option${mongodb_store_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mongodb_store_msgs_LIBRARIES "${interface_target_name}")
