...
bool operator==(const ::mongodb_store_msgs::MongoQueryMsgRequest_<ContainerAllocator1> & lhs, const ::mongodb_store_msgs::MongoQueryMsgRequest_<ContainerAllocator2> & rhs)
{
