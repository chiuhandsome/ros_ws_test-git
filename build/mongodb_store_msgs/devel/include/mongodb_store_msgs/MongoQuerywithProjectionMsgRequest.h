...
#if defined(_WIN32) && defined(JSON_QUERY)
  #undef JSON_QUERY
#endif
...
bool operator==(const ::mongodb_store_msgs::MongoQuerywithProjectionMsgRequest_<ContainerAllocator1> & lhs, const ::mongodb_store_msgs::MongoQuerywithProjectionMsgRequest_<ContainerAllocator2> & rhs)
{
  return lhs.database == rhs.database &&
    lhs.collection == rhs.collection &&
    lhs.type == rhs.type &&
    lhs.single == rhs.single &&
    lhs.limit == rhs.limit &&
    lhs.message_query == rhs.message_query &&
    lhs.meta_query == rhs.meta_query &&
    lhs.sort_query == rhs.sort_query &&
    lhs.projection_query == rhs.projection_query;
}
...
struct Definition< ::mongodb_store_msgs::MongoQuerywithProjectionMsgRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# message used for querying for ids of matching ROS msgs from a MongoDB database\n"
"\n"
