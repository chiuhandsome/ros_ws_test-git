...
;//! \htmlinclude cell_work_order_cmd-request.msg.html

(cl:defclass <cell_work_order_cmd-request> (roslisp-msg-protocol:ros-message)
  ((cmd_id
    :reader cmd_id
    :initarg :cmd_id
    :type cl:fixnum
   ...
   (request_data
    ...
    :type cellctrl_control_msgs-msg:cell_work_order
    :initform (cl:make-instance 'cellctrl_control_msgs-msg:cell_work_order)))
)

(cl:defclass cell_work_order_cmd-request (<cell_work_order_cmd-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <cell_work_order_cmd-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'cell_work_order_cmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cellctrl_control_msgs-srv:<cell_work_order_cmd-request> is deprecated: use cellctrl_control_msgs-srv:cell_work_order_cmd-request instead.")))

(cl:ensure-generic-function 'cmd_id-val :lambda-list '(m))
(cl:defmethod cmd_id-val ((m <cell_work_order_cmd-request>))
...
(cl:defmethod query_base_index-val ((m <cell_work_order_cmd-request>))
...
(cl:defmethod query_opt_index-val ((m <cell_work_order_cmd-request>))
...
(cl:defmethod query_parameter-val ((m <cell_work_order_cmd-request>))
...
(cl:defmethod request_data-val ((m <cell_work_order_cmd-request>))
  ...
  (request_data m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cell_work_order_cmd-request>) ostream)
  "Serializes a message object of type '<cell_work_order_cmd-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cell_work_order_cmd-request>) istream)
  "Deserializes a message object of type '<cell_work_order_cmd-request>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cell_work_order_cmd-request>)))
  "Returns string type for a service object of type '<cell_work_order_cmd-request>"
  "cellctrl_control_msgs/cell_work_order_cmdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cell_work_order_cmd-request)))
  "Returns string type for a service object of type 'cell_work_order_cmd-request"
  "cellctrl_control_msgs/cell_work_order_cmdRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cell_work_order_cmd-request>)))
  "Returns md5sum for a message object of type '<cell_work_order_cmd-request>"
  "95526e3ea0a3a629c0001a45315d94a3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cell_work_order_cmd-request)))
  "Returns md5sum for a message object of type 'cell_work_order_cmd-request"
  "95526e3ea0a3a629c0001a45315d94a3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cell_work_order_cmd-request>)))
  "Returns full string definition for message of type '<cell_work_order_cmd-request>"
  (cl:format cl:nil "int8 cmd_id         # 1:Add , 2:modify , 3:delete , 4:query , 5:refresh	 		~%string query_base_index 	~%string query_opt_index~%string query_parameter ~%cell_work_order request_data	 ~%~%================================================================================~%MSG: cellctrl_control_msgs/cell_work_order~%string primary_id			# must-have,UUID : primary_key(system_id)		~%string unique_code 		        # must-have,UNIQUE INDEX	~%string order_name		   ~%string order_desc 		 ~%string order_timestamp 		 ~%uint8  order_steps 		 ~%string update_time			# must-have 	 ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cell_work_order_cmd-request)))
  "Returns full string definition for message of type 'cell_work_order_cmd-request"
  (cl:format cl:nil "int8 cmd_id         # 1:Add , 2:modify , 3:delete , 4:query , 5:refresh	 		~%string query_base_index 	~%string query_opt_index~%string query_parameter ~%cell_work_order request_data	 ~%~%================================================================================~%MSG: cellctrl_control_msgs/cell_work_order~%string primary_id			# must-have,UUID : primary_key(system_id)		~%string unique_code 		        # must-have,UNIQUE INDEX	~%string order_name		   ~%string order_desc 		 ~%string order_timestamp 		 ~%uint8  order_steps 		 ~%string update_time			# must-have 	 ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <cell_work_order_cmd-request>))
  (cl:+ 0
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cell_work_order_cmd-request>))
  "Converts a ROS message object to a list"
  (cl:list 'cell_work_order_cmd-request
...
;//! \htmlinclude cell_work_order_cmd-response.msg.html

(cl:defclass <cell_work_order_cmd-response> (roslisp-msg-protocol:ros-message)
  ((result
    :reader result
    :initarg :result
    :type cl:boolean
   ...
   (response_data
    ...
    :type (cl:vector cellctrl_control_msgs-msg:cell_work_order)
   :initform (cl:make-array 0 :element-type 'cellctrl_control_msgs-msg:cell_work_order :initial-element (cl:make-instance 'cellctrl_control_msgs-msg:cell_work_order))))
)

(cl:defclass cell_work_order_cmd-response (<cell_work_order_cmd-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <cell_work_order_cmd-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'cell_work_order_cmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cellctrl_control_msgs-srv:<cell_work_order_cmd-response> is deprecated: use cellctrl_control_msgs-srv:cell_work_order_cmd-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <cell_work_order_cmd-response>))
...
(cl:defmethod error_code-val ((m <cell_work_order_cmd-response>))
...
(cl:defmethod primary_id-val ((m <cell_work_order_cmd-response>))
...
(cl:defmethod update_time-val ((m <cell_work_order_cmd-response>))
...
(cl:defmethod response_data-val ((m <cell_work_order_cmd-response>))
  ...
  (response_data m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cell_work_order_cmd-response>) ostream)
  "Serializes a message object of type '<cell_work_order_cmd-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cell_work_order_cmd-response>) istream)
  "Deserializes a message object of type '<cell_work_order_cmd-response>"
  ...
  (cl:let ((vals (cl:slot-value msg 'response_data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cellctrl_control_msgs-msg:cell_work_order))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cell_work_order_cmd-response>)))
  "Returns string type for a service object of type '<cell_work_order_cmd-response>"
  "cellctrl_control_msgs/cell_work_order_cmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cell_work_order_cmd-response)))
  "Returns string type for a service object of type 'cell_work_order_cmd-response"
  "cellctrl_control_msgs/cell_work_order_cmdResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cell_work_order_cmd-response>)))
  "Returns md5sum for a message object of type '<cell_work_order_cmd-response>"
  "95526e3ea0a3a629c0001a45315d94a3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cell_work_order_cmd-response)))
  "Returns md5sum for a message object of type 'cell_work_order_cmd-response"
  "95526e3ea0a3a629c0001a45315d94a3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cell_work_order_cmd-response>)))
  "Returns full string definition for message of type '<cell_work_order_cmd-response>"
  (cl:format cl:nil "bool result~%string error_code~%string primary_id~%string update_time~%cell_work_order[] response_data~%~%~%================================================================================~%MSG: cellctrl_control_msgs/cell_work_order~%string primary_id			# must-have,UUID : primary_key(system_id)		~%string unique_code 		        # must-have,UNIQUE INDEX	~%string order_name		   ~%string order_desc 		 ~%string order_timestamp 		 ~%uint8  order_steps 		 ~%string update_time			# must-have 	 ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cell_work_order_cmd-response)))
  "Returns full string definition for message of type 'cell_work_order_cmd-response"
  (cl:format cl:nil "bool result~%string error_code~%string primary_id~%string update_time~%cell_work_order[] response_data~%~%~%================================================================================~%MSG: cellctrl_control_msgs/cell_work_order~%string primary_id			# must-have,UUID : primary_key(system_id)		~%string unique_code 		        # must-have,UNIQUE INDEX	~%string order_name		   ~%string order_desc 		 ~%string order_timestamp 		 ~%uint8  order_steps 		 ~%string update_time			# must-have 	 ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <cell_work_order_cmd-response>))
  (cl:+ 0
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cell_work_order_cmd-response>))
  "Converts a ROS message object to a list"
  (cl:list 'cell_work_order_cmd-response
...
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'cell_work_order_cmd)))
  'cell_work_order_cmd-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'cell_work_order_cmd)))
  'cell_work_order_cmd-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cell_work_order_cmd)))
  "Returns string type for a service object of type '<cell_work_order_cmd>"
  "cellctrl_control_msgs/cell_work_order_cmd")