...
(cl:defclass <cell_work_stations> (roslisp-msg-protocol:ros-message)
  ((primary_id
    :reader primary_id
    :initarg :primary_id
    :type cl:string
...
(cl:defclass cell_work_stations (<cell_work_stations>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <cell_work_stations>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'cell_work_stations)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cellctrl_control_msgs-msg:<cell_work_stations> is deprecated: use cellctrl_control_msgs-msg:cell_work_stations instead.")))

(cl:ensure-generic-function 'primary_id-val :lambda-list '(m))
(cl:defmethod primary_id-val ((m <cell_work_stations>))
...
(cl:defmethod unique_code-val ((m <cell_work_stations>))
...
(cl:defmethod station_name-val ((m <cell_work_stations>))
...
(cl:defmethod cellcontroller_code-val ((m <cell_work_stations>))
...
(cl:defmethod positioned_pose-val ((m <cell_work_stations>))
...
(cl:defmethod mc_func_code-val ((m <cell_work_stations>))
...
(cl:defmethod transfer_code-val ((m <cell_work_stations>))
...
(cl:defmethod transfer_state-val ((m <cell_work_stations>))
...
(cl:defmethod align_type-val ((m <cell_work_stations>))
...
(cl:defmethod align_metadata-val ((m <cell_work_stations>))
...
(cl:defmethod pre_positioned_pose-val ((m <cell_work_stations>))
...
(cl:defmethod Identify_id-val ((m <cell_work_stations>))
...
(cl:defmethod update_time-val ((m <cell_work_stations>))
  ...
  (update_time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cell_work_stations>) ostream)
  "Serializes a message object of type '<cell_work_stations>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cell_work_stations>) istream)
  "Deserializes a message object of type '<cell_work_stations>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cell_work_stations>)))
  "Returns string type for a message object of type '<cell_work_stations>"
  "cellctrl_control_msgs/cell_work_stations")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cell_work_stations)))
  "Returns string type for a message object of type 'cell_work_stations"
  "cellctrl_control_msgs/cell_work_stations")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cell_work_stations>)))
  "Returns md5sum for a message object of type '<cell_work_stations>"
  "35ebd58c4ed76bc4d15807b8e51751b8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cell_work_stations)))
  "Returns md5sum for a message object of type 'cell_work_stations"
  "35ebd58c4ed76bc4d15807b8e51751b8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cell_work_stations>)))
  "Returns full string definition for message of type '<cell_work_stations>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cell_work_stations)))
  "Returns full string definition for message of type 'cell_work_stations"
  (cl:format cl:nil "string primary_id			# must-have,UUID : primary_key(system_id)~%string unique_code 		        # must-have,UNIQUE INDEX	~%string station_name		   ~%string cellcontroller_code 		 ~%geometry_msgs/Pose positioned_pose 		 ~%uint8  mc_func_code 	~%uint8  transfer_code 	~%uint8  transfer_state ~%uint8  align_type~%string align_metadata~%geometry_msgs/Pose pre_positioned_pose~%string Identify_id~%string update_time			# must-have 	 ~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <cell_work_stations>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cell_work_stations>))
  "Converts a ROS message object to a list"
  (cl:list 'cell_work_stations
