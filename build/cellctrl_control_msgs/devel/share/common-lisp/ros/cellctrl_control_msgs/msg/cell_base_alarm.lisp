...
;//! \htmlinclude cell_base_alarm.msg.html

(cl:defclass <cell_base_alarm> (roslisp-msg-protocol:ros-message)
  ((primary_id
    :reader primary_id
    :initarg :primary_id
    :type cl:string
...
(cl:defclass cell_base_alarm (<cell_base_alarm>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <cell_base_alarm>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'cell_base_alarm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cellctrl_control_msgs-msg:<cell_base_alarm> is deprecated: use cellctrl_control_msgs-msg:cell_base_alarm instead.")))

(cl:ensure-generic-function 'primary_id-val :lambda-list '(m))
(cl:defmethod primary_id-val ((m <cell_base_alarm>))
...
(cl:defmethod unique_code-val ((m <cell_base_alarm>))
...
(cl:defmethod base_name-val ((m <cell_base_alarm>))
...
(cl:defmethod alarm_level-val ((m <cell_base_alarm>))
...
(cl:defmethod base_desc_TC-val ((m <cell_base_alarm>))
...
(cl:defmethod base_desc_SC-val ((m <cell_base_alarm>))
...
(cl:defmethod base_desc_E-val ((m <cell_base_alarm>))
...
(cl:defmethod update_time-val ((m <cell_base_alarm>))
  ...
  (update_time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cell_base_alarm>) ostream)
  "Serializes a message object of type '<cell_base_alarm>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cell_base_alarm>) istream)
  "Deserializes a message object of type '<cell_base_alarm>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cell_base_alarm>)))
  "Returns string type for a message object of type '<cell_base_alarm>"
  "cellctrl_control_msgs/cell_base_alarm")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cell_base_alarm)))
  "Returns string type for a message object of type 'cell_base_alarm"
  "cellctrl_control_msgs/cell_base_alarm")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cell_base_alarm>)))
  "Returns md5sum for a message object of type '<cell_base_alarm>"
  "b8e010949dc861fc484d510573ba3baf")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cell_base_alarm)))
  "Returns md5sum for a message object of type 'cell_base_alarm"
  "b8e010949dc861fc484d510573ba3baf")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cell_base_alarm>)))
  "Returns full string definition for message of type '<cell_base_alarm>"
  (cl:format cl:nil "string primary_id			# must-have,UUID : primary_key(system_id)		~%string unique_code 		        # must-have,UNIQUE INDEX	~%string base_name		~%string alarm_level   ~%string base_desc_TC 		 ~%string base_desc_SC 		 ~%string base_desc_E 		 ~%string update_time			# must-have 	~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cell_base_alarm)))
  "Returns full string definition for message of type 'cell_base_alarm"
  (cl:format cl:nil "string primary_id			# must-have,UUID : primary_key(system_id)		~%string unique_code 		        # must-have,UNIQUE INDEX	~%string base_name		~%string alarm_level   ~%string base_desc_TC 		 ~%string base_desc_SC 		 ~%string base_desc_E 		 ~%string update_time			# must-have 	~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <cell_base_alarm>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cell_base_alarm>))
  "Converts a ROS message object to a list"
  (cl:list 'cell_base_alarm
