...
(cl:defclass <cell_base_transfer> (roslisp-msg-protocol:ros-message)
  ((primary_id
    :reader primary_id
    :initarg :primary_id
    :type cl:string
...
(cl:defclass cell_base_transfer (<cell_base_transfer>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <cell_base_transfer>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'cell_base_transfer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cellctrl_control_msgs-msg:<cell_base_transfer> is deprecated: use cellctrl_control_msgs-msg:cell_base_transfer instead.")))

(cl:ensure-generic-function 'primary_id-val :lambda-list '(m))
(cl:defmethod primary_id-val ((m <cell_base_transfer>))
...
(cl:defmethod unique_code-val ((m <cell_base_transfer>))
...
(cl:defmethod base_name-val ((m <cell_base_transfer>))
...
(cl:defmethod base_desc_TC-val ((m <cell_base_transfer>))
...
(cl:defmethod base_desc_SC-val ((m <cell_base_transfer>))
...
(cl:defmethod base_desc_E-val ((m <cell_base_transfer>))
...
(cl:defmethod update_time-val ((m <cell_base_transfer>))
  ...
  (update_time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cell_base_transfer>) ostream)
  "Serializes a message object of type '<cell_base_transfer>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cell_base_transfer>) istream)
  "Deserializes a message object of type '<cell_base_transfer>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cell_base_transfer>)))
  "Returns string type for a message object of type '<cell_base_transfer>"
  "cellctrl_control_msgs/cell_base_transfer")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cell_base_transfer)))
  "Returns string type for a message object of type 'cell_base_transfer"
  "cellctrl_control_msgs/cell_base_transfer")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cell_base_transfer>)))
  "Returns md5sum for a message object of type '<cell_base_transfer>"
  "7cae712ba514c2339344eb5e99f552cb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cell_base_transfer)))
  "Returns md5sum for a message object of type 'cell_base_transfer"
  "7cae712ba514c2339344eb5e99f552cb")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cell_base_transfer>)))
  "Returns full string definition for message of type '<cell_base_transfer>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cell_base_transfer)))
  "Returns full string definition for message of type 'cell_base_transfer"
  (cl:format cl:nil "string primary_id			# must-have,UUID : primary_key(system_id)		~%string unique_code 		        # must-have,UNIQUE INDEX	~%string base_name		   ~%string base_desc_TC 		 ~%string base_desc_SC 		 ~%string base_desc_E 		 ~%string update_time			# must-have 		 ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <cell_base_transfer>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cell_base_transfer>))
  "Converts a ROS message object to a list"
  (cl:list 'cell_base_transfer
