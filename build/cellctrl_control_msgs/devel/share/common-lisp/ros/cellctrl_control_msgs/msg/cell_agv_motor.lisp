...
;//! \htmlinclude cell_agv_motor.msg.html

(cl:defclass <cell_agv_motor> (roslisp-msg-protocol:ros-message)
  ((primary_id
    :reader primary_id
    :initarg :primary_id
    :type cl:string
...
(cl:defclass cell_agv_motor (<cell_agv_motor>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <cell_agv_motor>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'cell_agv_motor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cellctrl_control_msgs-msg:<cell_agv_motor> is deprecated: use cellctrl_control_msgs-msg:cell_agv_motor instead.")))

(cl:ensure-generic-function 'primary_id-val :lambda-list '(m))
(cl:defmethod primary_id-val ((m <cell_agv_motor>))
...
(cl:defmethod foreign_key-val ((m <cell_agv_motor>))
...
(cl:defmethod unique_code-val ((m <cell_agv_motor>))
...
(cl:defmethod tagname-val ((m <cell_agv_motor>))
...
(cl:defmethod tag_ser-val ((m <cell_agv_motor>))
...
(cl:defmethod device_code-val ((m <cell_agv_motor>))
...
(cl:defmethod device_serialno-val ((m <cell_agv_motor>))
...
(cl:defmethod put_in_service_date-val ((m <cell_agv_motor>))
...
(cl:defmethod work_comulative_time-val ((m <cell_agv_motor>))
...
(cl:defmethod current_status-val ((m <cell_agv_motor>))
...
(cl:defmethod update_time-val ((m <cell_agv_motor>))
  ...
  (update_time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cell_agv_motor>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cell_agv_motor>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cell_agv_motor>)))
  "Returns string type for a message object of type '<cell_agv_motor>"
  "cellctrl_control_msgs/cell_agv_motor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cell_agv_motor)))
  "Returns string type for a message object of type 'cell_agv_motor"
  "cellctrl_control_msgs/cell_agv_motor")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cell_agv_motor>)))
  "Returns md5sum for a message object of type '<cell_agv_motor>"
  "6cc23869890ef4a0917ab02d7306f61e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cell_agv_motor)))
  "Returns md5sum for a message object of type 'cell_agv_motor"
  "6cc23869890ef4a0917ab02d7306f61e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cell_agv_motor>)))
  "Returns full string definition for message of type '<cell_agv_motor>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cell_agv_motor)))
  "Returns full string definition for message of type 'cell_agv_motor"
  (cl:format cl:nil "string primary_id			# must-have,UUID : primary_key(system_id)~%string foreign_key~%string unique_code 		        # must-have,UNIQUE INDEX	~%string tagname		   ~%uint8 tag_ser ~%string device_code	~%string device_serialno	 ~%string put_in_service_date 		 ~%float32  work_comulative_time 	~%uint8  current_status ~%string update_time			# must-have 	 ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <cell_agv_motor>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <cell_agv_motor>))
  "Converts a ROS message object to a list"
  (cl:list 'cell_agv_motor
