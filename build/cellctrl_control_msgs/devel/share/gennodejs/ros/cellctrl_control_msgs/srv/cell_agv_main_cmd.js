...
let cell_agv_main = require('../msg/cell_agv_main.js');
...
class cell_agv_main_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_agv_main();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_main_cmdRequest
    ...
    bufferOffset = cell_agv_main.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_main_cmdRequest
    let len;
    let data = new cell_agv_main_cmdRequest(null);
    ...
    data.request_data = cell_agv_main.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_agv_main.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_agv_main_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '29816ee2ae67f6e2889348036e5e232d';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_main_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_agv_main.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_agv_main()
    }
...
class cell_agv_main_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_main_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_agv_main.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_main_cmdResponse
    let len;
    let data = new cell_agv_main_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_agv_main.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_agv_main.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_agv_main_cmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'a2a0e3f6cebe34d9980ac413990e3d1f';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_main_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_agv_main.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_agv_main_cmdRequest,
  Response: cell_agv_main_cmdResponse,
  md5sum() { return 'f2bae1739618b971d55e406910d9f410'; },
  datatype() { return 'cellctrl_control_msgs/cell_agv_main_cmd'; }
};
