...
let cell_work_order = require('../msg/cell_work_order.js');
...
class cell_work_order_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_work_order();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_work_order_cmdRequest
    ...
    bufferOffset = cell_work_order.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_work_order_cmdRequest
    let len;
    let data = new cell_work_order_cmdRequest(null);
    ...
    data.request_data = cell_work_order.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_work_order.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_work_order_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'de5d98bb31ac72ee5cb4afbf92a4922d';
  }
  ...
  static messageDefinition() {
    ...
    cell_work_order request_data	 
    
    ================================================================================
    MSG: cellctrl_control_msgs/cell_work_order
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_work_order_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_work_order.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_work_order()
    }
...
class cell_work_order_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_work_order_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_work_order.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_work_order_cmdResponse
    let len;
    let data = new cell_work_order_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_work_order.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_work_order.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_work_order_cmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'd6c0d405f0fafcb84bd735e07ec0f7fe';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_work_order_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_work_order.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_work_order_cmdRequest,
  Response: cell_work_order_cmdResponse,
  md5sum() { return '95526e3ea0a3a629c0001a45315d94a3'; },
  datatype() { return 'cellctrl_control_msgs/cell_work_order_cmd'; }
};
