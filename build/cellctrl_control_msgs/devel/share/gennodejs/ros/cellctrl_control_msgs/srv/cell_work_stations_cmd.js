...
let cell_work_stations = require('../msg/cell_work_stations.js');
...
class cell_work_stations_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_work_stations();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_work_stations_cmdRequest
    ...
    bufferOffset = cell_work_stations.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_work_stations_cmdRequest
    let len;
    let data = new cell_work_stations_cmdRequest(null);
    ...
    data.request_data = cell_work_stations.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_work_stations.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_work_stations_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '351ae83ca9fd0a40ca56b9ac1c80aee1';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_work_stations_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_work_stations.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_work_stations()
    }
...
class cell_work_stations_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_work_stations_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_work_stations.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_work_stations_cmdResponse
    let len;
    let data = new cell_work_stations_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_work_stations.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_work_stations.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_work_stations_cmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '46c2f4cdd6611634938dfdd3daa34131';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_work_stations_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_work_stations.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_work_stations_cmdRequest,
  Response: cell_work_stations_cmdResponse,
  md5sum() { return 'ed4e17f80f5c35699b21d211a45f2926'; },
  datatype() { return 'cellctrl_control_msgs/cell_work_stations_cmd'; }
};
