...
let cell_work_orderitems = require('../msg/cell_work_orderitems.js');
...
class cell_work_orderitems_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_work_orderitems();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_work_orderitems_cmdRequest
    ...
    bufferOffset = cell_work_orderitems.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_work_orderitems_cmdRequest
    let len;
    let data = new cell_work_orderitems_cmdRequest(null);
    ...
    data.request_data = cell_work_orderitems.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_work_orderitems.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_work_orderitems_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e5c8a208e711f8160f6e449402e64596';
  }
  ...
  static messageDefinition() {
    ...
    cell_work_orderitems request_data	 
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_work_orderitems_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_work_orderitems.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_work_orderitems()
    }
...
class cell_work_orderitems_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_work_orderitems_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_work_orderitems.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_work_orderitems_cmdResponse
    let len;
    let data = new cell_work_orderitems_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_work_orderitems.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_work_orderitems.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_work_orderitems_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_work_orderitems.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_work_orderitems_cmdRequest,
  Response: cell_work_orderitems_cmdResponse,
  md5sum() { return '08a8cb70fbdb3b9e29d5a90913c957d3'; },
  datatype() { return 'cellctrl_control_msgs/cell_work_orderitems_cmd'; }
};
