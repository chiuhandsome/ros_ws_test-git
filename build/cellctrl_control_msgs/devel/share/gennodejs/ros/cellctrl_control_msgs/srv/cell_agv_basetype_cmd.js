...
let cell_agv_basetype = require('../msg/cell_agv_basetype.js');
...
class cell_agv_basetype_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.req_cell_agv_basetype = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('req_cell_agv_basetype')) {
        this.req_cell_agv_basetype = initObj.req_cell_agv_basetype
      }
      else {
        this.req_cell_agv_basetype = new cell_agv_basetype();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_basetype_cmdRequest
    ...
    // Serialize message field [req_cell_agv_basetype]
    bufferOffset = cell_agv_basetype.serialize(obj.req_cell_agv_basetype, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_basetype_cmdRequest
    let len;
    let data = new cell_agv_basetype_cmdRequest(null);
    ...
    // Deserialize message field [req_cell_agv_basetype]
    data.req_cell_agv_basetype = cell_agv_basetype.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_agv_basetype.getMessageSize(object.req_cell_agv_basetype);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_agv_basetype_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '11862b61635ce4dd9805af4e3a042149';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_basetype_cmdRequest(null);
    ...
    if (msg.req_cell_agv_basetype !== undefined) {
      resolved.req_cell_agv_basetype = cell_agv_basetype.Resolve(msg.req_cell_agv_basetype)
    }
    else {
      resolved.req_cell_agv_basetype = new cell_agv_basetype()
    }
...
class cell_agv_basetype_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
      ...
      this.result_cell_agv_basetype = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('result_cell_agv_basetype')) {
        this.result_cell_agv_basetype = initObj.result_cell_agv_basetype
      }
      else {
        this.result_cell_agv_basetype = [];
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_basetype_cmdResponse
    ...
    // Serialize message field [result_cell_agv_basetype]
    // Serialize the length for message field [result_cell_agv_basetype]
    bufferOffset = _serializer.uint32(obj.result_cell_agv_basetype.length, buffer, bufferOffset);
    obj.result_cell_agv_basetype.forEach((val) => {
      bufferOffset = cell_agv_basetype.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_basetype_cmdResponse
    let len;
    let data = new cell_agv_basetype_cmdResponse(null);
    ...
    // Deserialize message field [result_cell_agv_basetype]
    // Deserialize array length for message field [result_cell_agv_basetype]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.result_cell_agv_basetype = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.result_cell_agv_basetype[i] = cell_agv_basetype.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.result_cell_agv_basetype.forEach((val) => {
      length += cell_agv_basetype.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_basetype_cmdResponse(null);
    ...
    if (msg.result_cell_agv_basetype !== undefined) {
      resolved.result_cell_agv_basetype = new Array(msg.result_cell_agv_basetype.length);
      for (let i = 0; i < resolved.result_cell_agv_basetype.length; ++i) {
        resolved.result_cell_agv_basetype[i] = cell_agv_basetype.Resolve(msg.result_cell_agv_basetype[i]);
      }
    }
    else {
      resolved.result_cell_agv_basetype = []
    }
...
module.exports = {
  Request: cell_agv_basetype_cmdRequest,
  Response: cell_agv_basetype_cmdResponse,
  md5sum() { return '11e37d39fe631d47c03fb6e0e1ac23c7'; },
  datatype() { return 'cellctrl_control_msgs/cell_agv_basetype_cmd'; }
};
