...
let cell_agv_battery = require('../msg/cell_agv_battery.js');
...
class cell_agv_battery_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_agv_battery();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_battery_cmdRequest
    ...
    bufferOffset = cell_agv_battery.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_battery_cmdRequest
    let len;
    let data = new cell_agv_battery_cmdRequest(null);
    ...
    data.request_data = cell_agv_battery.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_agv_battery.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_agv_battery_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '22010d55f97e004c690a8e99c3f08bbf';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_battery_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_agv_battery.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_agv_battery()
    }
...
class cell_agv_battery_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_battery_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_agv_battery.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_battery_cmdResponse
    let len;
    let data = new cell_agv_battery_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_agv_battery.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_agv_battery.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_agv_battery_cmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '7e5288384f4827adf5b952b9f9133c32';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_battery_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_agv_battery.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_agv_battery_cmdRequest,
  Response: cell_agv_battery_cmdResponse,
  md5sum() { return '5216cab84309d13ed384bd087dcdd19e'; },
  datatype() { return 'cellctrl_control_msgs/cell_agv_battery_cmd'; }
};
