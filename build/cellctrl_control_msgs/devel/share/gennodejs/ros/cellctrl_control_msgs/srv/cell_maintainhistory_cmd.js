...
let cell_maintainhistory = require('../msg/cell_maintainhistory.js');
...
class cell_maintainhistory_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_maintainhistory();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_maintainhistory_cmdRequest
    ...
    bufferOffset = cell_maintainhistory.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_maintainhistory_cmdRequest
    let len;
    let data = new cell_maintainhistory_cmdRequest(null);
    ...
    data.request_data = cell_maintainhistory.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_maintainhistory.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_maintainhistory_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '2cac1f814ed2ff5f45429673e797f9a2';
  }
  ...
  static messageDefinition() {
    ...
    cell_maintainhistory request_data	 
    
    ================================================================================
    MSG: cellctrl_control_msgs/cell_maintainhistory
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_maintainhistory_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_maintainhistory.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_maintainhistory()
    }
...
class cell_maintainhistory_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_maintainhistory_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_maintainhistory.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_maintainhistory_cmdResponse
    let len;
    let data = new cell_maintainhistory_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_maintainhistory.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_maintainhistory.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_maintainhistory_cmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '316e55a15f5a7c58c22b5f994c9d4cca';
  }
  ...
  static messageDefinition() {
    ...
    string primary_id
    string update_time
    cell_maintainhistory[] response_data
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_maintainhistory_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_maintainhistory.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_maintainhistory_cmdRequest,
  Response: cell_maintainhistory_cmdResponse,
  md5sum() { return '243df461b83334c8472797f221ffd242'; },
  datatype() { return 'cellctrl_control_msgs/cell_maintainhistory_cmd'; }
};
