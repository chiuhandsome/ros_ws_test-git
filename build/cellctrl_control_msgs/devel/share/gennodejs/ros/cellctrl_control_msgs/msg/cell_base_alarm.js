...
class cell_base_alarm {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new cell_base_alarm(null);
  ...
  static datatype() {
    ...
    return 'cellctrl_control_msgs/cell_base_alarm';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'b8e010949dc861fc484d510573ba3baf';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_base_alarm(null);
...
module.exports = cell_base_alarm;
