...
class cell_agv_lidar {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new cell_agv_lidar(null);
  ...
  static datatype() {
    ...
    return 'cellctrl_control_msgs/cell_agv_lidar';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_lidar(null);
