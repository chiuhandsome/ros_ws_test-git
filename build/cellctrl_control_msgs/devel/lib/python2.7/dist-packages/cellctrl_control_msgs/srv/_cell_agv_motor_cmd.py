...
"""autogenerated by genpy from cellctrl_control_msgs/cell_agv_motor_cmdRequest.msg. Do not edit."""
import sys
...
class cell_agv_motor_cmdRequest(genpy.Message):
  _md5sum = "8e89104b8f96e405c022dbd17d1c4ecf"
  _type = "cellctrl_control_msgs/cell_agv_motor_cmdRequest"
...
"""
  ...
  _slot_types = ['int8','string','string','string','cellctrl_control_msgs/cell_agv_motor']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_agv_motor_cmdRequest, self).__init__(*args, **kwds)
      ...
      if self.request_data is None:
        self.request_data = cellctrl_control_msgs.msg.cell_agv_motor()
    else:
      self.cmd_id = 0
      self.query_base_index = ''
      self.query_opt_index = ''
...
def _get_struct_fB():
    ...
    return _struct_fB
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cellctrl_control_msgs/cell_agv_motor_cmdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class cell_agv_motor_cmdResponse(genpy.Message):
  _md5sum = "d3d863d7a6e5e617a9ff8a50a6d53ab9"
  _type = "cellctrl_control_msgs/cell_agv_motor_cmdResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','string','string','string','cellctrl_control_msgs/cell_agv_motor[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_agv_motor_cmdResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cellctrl_control_msgs.msg.cell_agv_motor()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
def _get_struct_fB():
    ...
    if _struct_fB is None:
        _struct_fB = struct.Struct("<fB")
    return _struct_fB
class cell_agv_motor_cmd(object):
  _type          = 'cellctrl_control_msgs/cell_agv_motor_cmd'
  _md5sum = '5b06aeba6c9560a399222d693fe7ca2c'
  _request_class  = cell_agv_motor_cmdRequest
  _response_class = cell_agv_motor_cmdResponse
