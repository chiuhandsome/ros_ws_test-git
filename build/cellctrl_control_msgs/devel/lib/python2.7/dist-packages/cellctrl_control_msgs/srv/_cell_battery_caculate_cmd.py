...
"""autogenerated by genpy from cellctrl_control_msgs/cell_battery_caculate_cmdRequest.msg. Do not edit."""
import sys
...
class cell_battery_caculate_cmdRequest(genpy.Message):
  _md5sum = "6c40b7d8026a79d9c56f76aecb0ff75d"
  _type = "cellctrl_control_msgs/cell_battery_caculate_cmdRequest"
...
"""
  ...
  _slot_types = ['int8','string','string','string','cellctrl_control_msgs/cell_battery_caculate']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_battery_caculate_cmdRequest, self).__init__(*args, **kwds)
      ...
      if self.request_data is None:
        self.request_data = cellctrl_control_msgs.msg.cell_battery_caculate()
    else:
      self.cmd_id = 0
      self.query_base_index = ''
      self.query_opt_index = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.request_data.segment_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B2f().pack(_x.request_data.segment_ser, _x.request_data.ctrl_seg_capacity, _x.request_data.ctrl_seg_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.request_data.segment_name = str[start:end].decode('utf-8')
      else:
        self.request_data.segment_name = str[start:end]
      _x = self
      start = end
      end += 9
      (_x.request_data.segment_ser, _x.request_data.ctrl_seg_capacity, _x.request_data.ctrl_seg_distance,) = _get_struct_B2f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cellctrl_control_msgs/cell_battery_caculate_cmdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class cell_battery_caculate_cmdResponse(genpy.Message):
  _md5sum = "5252da2aefeea0defcf24e52844f259f"
  _type = "cellctrl_control_msgs/cell_battery_caculate_cmdResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','string','string','string','cellctrl_control_msgs/cell_battery_caculate[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_battery_caculate_cmdResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cellctrl_control_msgs.msg.cell_battery_caculate()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
def _get_struct_B2f():
    ...
    if _struct_B2f is None:
        _struct_B2f = struct.Struct("<B2f")
    return _struct_B2f
class cell_battery_caculate_cmd(object):
  _type          = 'cellctrl_control_msgs/cell_battery_caculate_cmd'
  _md5sum = 'dcdb5e464a630a6f21bef14a4fb71044'
  _request_class  = cell_battery_caculate_cmdRequest
  _response_class = cell_battery_caculate_cmdResponse
