...
"""autogenerated by genpy from cellctrl_control_msgs/cell_work_ordergoods_cmdRequest.msg. Do not edit."""
import sys
...
class cell_work_ordergoods_cmdRequest(genpy.Message):
  _md5sum = "0f288d81ba511089268f3b8bfe3cdb7c"
  _type = "cellctrl_control_msgs/cell_work_ordergoods_cmdRequest"
...
"""
  ...
  _slot_types = ['int8','string','string','string','cellctrl_control_msgs/cell_work_ordergoods']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_work_ordergoods_cmdRequest, self).__init__(*args, **kwds)
      ...
      if self.request_data is None:
        self.request_data = cellctrl_control_msgs.msg.cell_work_ordergoods()
    else:
      self.cmd_id = 0
      self.query_base_index = ''
      self.query_opt_index = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.request_data.order_goods_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.request_data.order_goods_desc
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.request_data.order_goods_name = str[start:end].decode('utf-8')
      else:
        self.request_data.order_goods_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.request_data.order_goods_desc = str[start:end].decode('utf-8')
      else:
        self.request_data.order_goods_desc = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cellctrl_control_msgs/cell_work_ordergoods_cmdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class cell_work_ordergoods_cmdResponse(genpy.Message):
  _md5sum = "147933279d1bc8d3d81b0502bb2a63de"
  _type = "cellctrl_control_msgs/cell_work_ordergoods_cmdResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','string','string','string','cellctrl_control_msgs/cell_work_ordergoods[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_work_ordergoods_cmdResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
    ...
    try:
      ...
      for val1 in self.response_data:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1.order_goods_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1.order_goods_desc
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cellctrl_control_msgs.msg.cell_work_ordergoods()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.order_goods_name = str[start:end].decode('utf-8')
        else:
          val1.order_goods_name = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.order_goods_desc = str[start:end].decode('utf-8')
        else:
          val1.order_goods_desc = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
def _get_struct_B():
    ...
    if _struct_B is None:
        _struct_B = struct.Struct("<B")
    return _struct_B
class cell_work_ordergoods_cmd(object):
  _type          = 'cellctrl_control_msgs/cell_work_ordergoods_cmd'
  _md5sum = 'a39af5e267cfcbbc4899b66e549fff7f'
  _request_class  = cell_work_ordergoods_cmdRequest
  _response_class = cell_work_ordergoods_cmdResponse
