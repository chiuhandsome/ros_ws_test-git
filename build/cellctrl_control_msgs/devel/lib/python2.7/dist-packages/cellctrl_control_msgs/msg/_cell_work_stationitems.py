...
"""autogenerated by genpy from cellctrl_control_msgs/cell_work_stationitems.msg. Do not edit."""
import sys
...
class cell_work_stationitems(genpy.Message):
  _md5sum = "4fa12b8714fb4a13b138a13c3f297691"
  _type = "cellctrl_control_msgs/cell_work_stationitems"
...
float64 w
"""
  __slots__ = ['primary_id','foreign_key','unique_code','station_name','station_ser','cellcontroller_code','positioned_pose','mc_func_code','transfer_code','transfer_state','align_type','align_metadata','pre_positioned_pose','Identify_id','update_time']
  _slot_types = ['string','string','string','string','uint8','string','geometry_msgs/Pose','uint8','uint8','uint8','uint8','string','geometry_msgs/Pose','string','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       primary_id,foreign_key,unique_code,station_name,station_ser,cellcontroller_code,positioned_pose,mc_func_code,transfer_code,transfer_state,align_type,align_metadata,pre_positioned_pose,Identify_id,update_time
    ...
    """
    if args or kwds:
      super(cell_work_stationitems, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.station_ser,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
