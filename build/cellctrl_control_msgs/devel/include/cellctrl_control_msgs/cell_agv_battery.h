// Generated by gencpp from file cellctrl_control_msgs/cell_agv_battery.msg
// DO NOT EDIT!


#ifndef CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_AGV_BATTERY_H
#define CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_AGV_BATTERY_H
...
struct cell_agv_battery_
{
  typedef cell_agv_battery_<ContainerAllocator> Type;
  ...
  cell_agv_battery_(const ContainerAllocator& _alloc)
    : primary_id(_alloc)
    , foreign_key(_alloc)
    , unique_code(_alloc)
    , tagname(_alloc)
  ...
  _device_serialno_type device_serialno;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _caculate_code_type;
  _caculate_code_type caculate_code;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _remain_code_type;
  _remain_code_type remain_code;
  ...
  typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> const> ConstPtr;

}; // struct cell_agv_battery_

typedef ::cellctrl_control_msgs::cell_agv_battery_<std::allocator<void> > cell_agv_battery;

typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_agv_battery > cell_agv_batteryPtr;
typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_agv_battery const> cell_agv_batteryConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator1> & lhs, const ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator2> & rhs)
{
  return lhs.primary_id == rhs.primary_id &&
    ...
    lhs.caculate_code == rhs.caculate_code &&
    lhs.remain_code == rhs.remain_code &&
    ...
    lhs.current_capacity == rhs.current_capacity &&
...
template <class ContainerAllocator>
struct IsFixedSize< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5eb3a13fc49984edULL;
  static const uint64_t static_value2 = 0xf8e4c2f85255eb85ULL;
};

template<class ContainerAllocator>
struct DataType< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cellctrl_control_msgs::cell_agv_battery_<ContainerAllocator>& v)
  {
    s << indent << "primary_id: ";
    ...
    s << indent << "caculate_code: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.caculate_code);
    s << indent << "remain_code: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.remain_code);
    ...
    s << indent << "current_capacity: ";
    Printer<float>::stream(s, indent + "  ", v.current_capacity);
...
#endif // CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_AGV_BATTERY_H
