// Generated by gencpp from file cellctrl_control_msgs/cell_work_stationitems.msg
// DO NOT EDIT!


#ifndef CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_WORK_STATIONITEMS_H
#define CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_WORK_STATIONITEMS_H
...
struct cell_work_stationitems_
{
  typedef cell_work_stationitems_<ContainerAllocator> Type;

  cell_work_stationitems_()
    : primary_id()
    , foreign_key()
    , unique_code()
    , station_name()
  ...
  cell_work_stationitems_(const ContainerAllocator& _alloc)
    : primary_id(_alloc)
    , foreign_key(_alloc)
    , unique_code(_alloc)
    , station_name(_alloc)
  ...
  _station_name_type station_name;
   ...
   typedef uint8_t _station_ser_type;
  _station_ser_type station_ser;
  ...
  typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> const> ConstPtr;

}; // struct cell_work_stationitems_

typedef ::cellctrl_control_msgs::cell_work_stationitems_<std::allocator<void> > cell_work_stationitems;

typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_work_stationitems > cell_work_stationitemsPtr;
typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_work_stationitems const> cell_work_stationitemsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator1> & lhs, const ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator2> & rhs)
{
  return lhs.primary_id == rhs.primary_id &&
    ...
    lhs.station_ser == rhs.station_ser &&
...
template <class ContainerAllocator>
struct IsFixedSize< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4fa12b8714fb4a13ULL;
  static const uint64_t static_value2 = 0xb138a13c3f297691ULL;
};

template<class ContainerAllocator>
struct DataType< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cellctrl_control_msgs::cell_work_stationitems_<ContainerAllocator>& v)
  {
    s << indent << "primary_id: ";
    ...
    s << indent << "station_ser: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.station_ser);
...
#endif // CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_WORK_STATIONITEMS_H
