// Generated by gencpp from file cellctrl_control_msgs/cell_agv_lidar.msg
// DO NOT EDIT!


#ifndef CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_AGV_LIDAR_H
#define CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_AGV_LIDAR_H
...
struct cell_agv_lidar_
{
  typedef cell_agv_lidar_<ContainerAllocator> Type;
  ...
  cell_agv_lidar_(const ContainerAllocator& _alloc)
    : primary_id(_alloc)
    , foreign_key(_alloc)
    , unique_code(_alloc)
    , tagname(_alloc)
  ...
  typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> const> ConstPtr;

}; // struct cell_agv_lidar_

typedef ::cellctrl_control_msgs::cell_agv_lidar_<std::allocator<void> > cell_agv_lidar;

typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_agv_lidar > cell_agv_lidarPtr;
typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_agv_lidar const> cell_agv_lidarConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator1> & lhs, const ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6cc23869890ef4a0ULL;
  static const uint64_t static_value2 = 0x917ab02d7306f61eULL;
};

template<class ContainerAllocator>
struct DataType< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cellctrl_control_msgs::cell_agv_lidar_<ContainerAllocator>& v)
  {
    s << indent << "primary_id: ";
...
#endif // CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_AGV_LIDAR_H
