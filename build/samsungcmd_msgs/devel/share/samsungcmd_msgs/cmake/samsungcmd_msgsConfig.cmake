...
if(samsungcmd_msgs_CONFIG_INCLUDED)
  return()
endif()
set(samsungcmd_msgs_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(samsungcmd_msgs_SOURCE_PREFIX /home/handsome/ros_ws_test/src/ros_base/samsungcmd_msgs)
  set(samsungcmd_msgs_DEVEL_PREFIX /home/handsome/ros_ws_test/build/samsungcmd_msgs/devel)
  set(samsungcmd_msgs_INSTALL_PREFIX "")
  set(samsungcmd_msgs_PREFIX ${samsungcmd_msgs_DEVEL_PREFIX})
else()
  set(samsungcmd_msgs_SOURCE_PREFIX "")
  set(samsungcmd_msgs_DEVEL_PREFIX "")
  set(samsungcmd_msgs_INSTALL_PREFIX /home/handsome/ros_ws_test/install/samsungcmd_msgs)
  set(samsungcmd_msgs_PREFIX ${samsungcmd_msgs_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'samsungcmd_msgs' is deprecated")
...
set(samsungcmd_msgs_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/handsome/ros_ws_test/build/samsungcmd_msgs/devel/include " STREQUAL " ")
  set(samsungcmd_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsome/ros_ws_test/build/samsungcmd_msgs/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${samsungcmd_msgs_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'samsungcmd_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'samsungcmd_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsome/ros_ws_test/src/ros_base/samsungcmd_msgs/${idir}'.  ${_report}")
    endif()
    _list_append_unique(samsungcmd_msgs_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND samsungcmd_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND samsungcmd_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT samsungcmd_msgs_NUM_DUMMY_TARGETS)
      set(samsungcmd_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::samsungcmd_msgs::wrapped-linker-option${samsungcmd_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR samsungcmd_msgs_NUM_DUMMY_TARGETS "${samsungcmd_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::samsungcmd_msgs::wrapped-linker-option${samsungcmd_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND samsungcmd_msgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(samsungcmd_msgs_LIBRARY_DIRS ${lib_path})
      list(APPEND samsungcmd_msgs_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'samsungcmd_msgs'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND samsungcmd_msgs_LIBRARIES ${lib})
    endif()
  endif()
...
set(samsungcmd_msgs_EXPORTED_TARGETS "samsungcmd_msgs_generate_messages_cpp;samsungcmd_msgs_generate_messages_eus;samsungcmd_msgs_generate_messages_lisp;samsungcmd_msgs_generate_messages_nodejs;samsungcmd_msgs_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${samsungcmd_msgs_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 samsungcmd_msgs_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${samsungcmd_msgs_dep}_FOUND)
      find_package(${samsungcmd_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${samsungcmd_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(samsungcmd_msgs_INCLUDE_DIRS ${${samsungcmd_msgs_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(samsungcmd_msgs_LIBRARIES ${samsungcmd_msgs_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${samsungcmd_msgs_dep}_LIBRARIES})
  _list_append_deduplicate(samsungcmd_msgs_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(samsungcmd_msgs_LIBRARIES ${samsungcmd_msgs_LIBRARIES})

  _list_append_unique(samsungcmd_msgs_LIBRARY_DIRS ${${samsungcmd_msgs_dep}_LIBRARY_DIRS})
  list(APPEND samsungcmd_msgs_EXPORTED_TARGETS ${${samsungcmd_msgs_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "samsungcmd_msgs-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${samsungcmd_msgs_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
