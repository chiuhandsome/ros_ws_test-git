...
"""autogenerated by genpy from samsungcmd_msgs/samsung_alarmHistory.msg. Do not edit."""
import sys
...
class samsung_alarmHistory(genpy.Message):
  _md5sum = "8eaf1cb50ac427c6ec57697237bdf914"
  _type = "samsungcmd_msgs/samsung_alarmHistory"
...
"""
  __slots__ = ['system_id','alarm_id','alarm_code','alarm_level','alarm_occure_time','alarm_update_time']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       system_id,alarm_id,alarm_code,alarm_level,alarm_occure_time,alarm_update_time
    ...
    """
    if args or kwds:
      super(samsung_alarmHistory, self).__init__(*args, **kwds)
