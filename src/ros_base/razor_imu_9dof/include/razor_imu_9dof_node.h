...
typedef enum {S_IDLE,S_INIT,S_PARAM,S_PARAM_SUCCESS,S_PARAM_RUNNING,S_SYNCH,S_SYNCH_SUCCESS,S_SYNCH_FAIL,S_START_READ_DATA,S_READ_DATA_RUNNING,S_DATA} Comm_Status ;
...
private:
   ...
   std::chrono::duration<double, std::milli> watchdog_time_ ;
