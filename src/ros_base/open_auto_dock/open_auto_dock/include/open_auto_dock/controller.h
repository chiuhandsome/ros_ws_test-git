...
private:
  ...
  double distance_speed ; //distance for speed split(two statge control)
  double distance_closing ; //distance for closing (dist_)
  double distance_closed ;
