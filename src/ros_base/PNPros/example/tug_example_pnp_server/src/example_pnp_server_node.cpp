    ...
    runable_(true)
{
    ...
    */
    function_map_.insert(std::pair<std::string, boost::function<void(bool*,std::string)> >("FetchBox", boost::bind(&ExamplePNPServer::fetchBox,this,_1,_2)));
    function_map_.insert(std::pair<std::string, boost::function<void(bool*,std::string)> >("TransportBox", boost::bind(&ExamplePNPServer::transportBox,this,_1,_2)));
    function_map_.insert(std::pair<std::string, boost::function<void(bool*,std::string)> >("Put", boost::bind(&ExamplePNPServer::putBox,this,_1,_2)));
    function_map_.insert(std::pair<std::string, boost::function<void(bool*,std::string)> >("Recovery", boost::bind(&ExamplePNPServer::recoveryNotFetchingBox,this,_1,_2)));
    function_map_.insert(std::pair<std::string, boost::function<void(bool*,std::string)> >("RecoveryTimeOut", boost::bind(&ExamplePNPServer::recoveryTimedOut,this,_1,_2)));
    function_map_.insert(std::pair<std::string, boost::function<void(bool*,std::string)> >("init", boost::bind(&ExamplePNPServer::init,this,_1,_2)));
    //fetch box state
    fetch_box_state_ = -1;
}
...
int ExamplePNPServer::evalCondition(string condition)
{
   ...
   // }
    ...
    /*if((condition == "run")&&(fetch_box_state_ == static_cast<int>(tug_example_msgs::FetchBoxResult::RUN)) )
    {
        fetch_box_state_ = -1;
        return 1;
    }*/
...
void ExamplePNPServer::fetchBox(bool *run,std::string params)
{
    if(!(*run))
        return;
...
void ExamplePNPServer::transportBox(bool *run,std::string params)
{
    if(!(*run))
        return;
...
void ExamplePNPServer::putBox(bool *run,std::string params)
{
    if(!(*run))
        return;
...
void ExamplePNPServer::recoveryNotFetchingBox(bool *run,std::string params)
{
    if(!(*run))
        return;
...
void ExamplePNPServer::recoveryTimedOut(bool *run,std::string params)
{
    if(!(*run))
        return;
...
void ExamplePNPServer::init(bool *run,std::string params)
{
