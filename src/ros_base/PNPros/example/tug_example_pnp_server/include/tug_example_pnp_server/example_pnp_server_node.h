...
public:
    ...
    void fetchBox(bool *run,std::string params);
    void transportBox(bool *run,std::string params);
    void putBox(bool *run,std::string params);
    void recoveryNotFetchingBox(bool *run,std::string params);
    void recoveryTimedOut(bool *run,std::string params);
