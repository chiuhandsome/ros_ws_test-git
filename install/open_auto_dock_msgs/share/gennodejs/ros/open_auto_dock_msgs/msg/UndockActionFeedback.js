...
class UndockActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = UndockFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UndockActionFeedback(null);
    ...
    data.feedback = UndockFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += UndockFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UndockActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = UndockFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new UndockFeedback()
    }
...
module.exports = UndockActionFeedback;
