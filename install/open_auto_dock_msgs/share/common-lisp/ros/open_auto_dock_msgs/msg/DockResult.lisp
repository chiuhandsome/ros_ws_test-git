...
(cl:defmethod cl:initialize-instance :after ((m <DockResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DockResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name open_auto_dock_msgs-msg:<DockResult> is deprecated: use open_auto_dock_msgs-msg:DockResult instead.")))

(cl:ensure-generic-function 'docked-val :lambda-list '(m))
(cl:defmethod docked-val ((m <DockResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader open_auto_dock_msgs-msg:docked-val is deprecated.  Use open_auto_dock_msgs-msg:docked instead.")
  (docked m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DockResult>)))
  ...
  "open_auto_dock_msgs/DockResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DockResult)))
  "Returns string type for a message object of type 'DockResult"
  "open_auto_dock_msgs/DockResult")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DockResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Are we docked and charging?~%bool docked~%~%# Name of the dock, if known~%string dock_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DockResult)))
  "Returns full string definition for message of type 'DockResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Are we docked and charging?~%bool docked~%~%# Name of the dock, if known~%string dock_id~%~%~%"))
