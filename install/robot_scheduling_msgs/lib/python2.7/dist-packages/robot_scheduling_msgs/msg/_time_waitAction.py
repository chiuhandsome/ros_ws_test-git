...
"""autogenerated by genpy from robot_scheduling_msgs/time_waitAction.msg. Do not edit."""
import sys
...
class time_waitAction(genpy.Message):
  _md5sum = "e177d065e4b6b0c598ebc0bd62d4fda9"
  _type = "robot_scheduling_msgs/time_waitAction"
...
"""
  ...
  _slot_types = ['robot_scheduling_msgs/time_waitActionGoal','robot_scheduling_msgs/time_waitActionResult','robot_scheduling_msgs/time_waitActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(time_waitAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = robot_scheduling_msgs.msg.time_waitActionGoal()
      if self.action_result is None:
        self.action_result = robot_scheduling_msgs.msg.time_waitActionResult()
      if self.action_feedback is None:
        self.action_feedback = robot_scheduling_msgs.msg.time_waitActionFeedback()
    else:
      self.action_goal = robot_scheduling_msgs.msg.time_waitActionGoal()
      self.action_result = robot_scheduling_msgs.msg.time_waitActionResult()
      self.action_feedback = robot_scheduling_msgs.msg.time_waitActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_Bf().pack(_x.action_goal.goal.cmd_type, _x.action_goal.goal.cmd_time))
      _x = self.action_goal.goal.time_wait_ac_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.cmd_type, _x.action_goal.goal.cmd_time,) = _get_struct_Bf().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.time_wait_ac_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.time_wait_ac_name = str[start:end]
      _x = self
      start = end
      end += 12
