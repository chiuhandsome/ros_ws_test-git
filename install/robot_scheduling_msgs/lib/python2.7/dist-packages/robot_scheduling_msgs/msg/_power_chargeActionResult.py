...
"""autogenerated by genpy from robot_scheduling_msgs/power_chargeActionResult.msg. Do not edit."""
import sys
...
class power_chargeActionResult(genpy.Message):
  _md5sum = "c00603f04e6a4e0a80542f4fd8c335d0"
  _type = "robot_scheduling_msgs/power_chargeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/power_chargeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(power_chargeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_scheduling_msgs.msg.power_chargeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_scheduling_msgs.msg.power_chargeResult()
