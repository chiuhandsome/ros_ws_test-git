...
"""autogenerated by genpy from robot_scheduling_msgs/interrupt_infoActionResult.msg. Do not edit."""
import sys
...
class interrupt_infoActionResult(genpy.Message):
  _md5sum = "8b74209535e99df65b476df1512f7f83"
  _type = "robot_scheduling_msgs/interrupt_infoActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/interrupt_infoResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(interrupt_infoActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_scheduling_msgs.msg.interrupt_infoResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_scheduling_msgs.msg.interrupt_infoResult()
