...
"""autogenerated by genpy from robot_scheduling_msgs/worksheetrunAction.msg. Do not edit."""
import sys
...
class worksheetrunAction(genpy.Message):
  _md5sum = "9cbd17c83be57790a53a046922f0c99f"
  _type = "robot_scheduling_msgs/worksheetrunAction"
...
"""
  ...
  _slot_types = ['robot_scheduling_msgs/worksheetrunActionGoal','robot_scheduling_msgs/worksheetrunActionResult','robot_scheduling_msgs/worksheetrunActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(worksheetrunAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = robot_scheduling_msgs.msg.worksheetrunActionGoal()
      if self.action_result is None:
        self.action_result = robot_scheduling_msgs.msg.worksheetrunActionResult()
      if self.action_feedback is None:
        self.action_feedback = robot_scheduling_msgs.msg.worksheetrunActionFeedback()
    else:
      self.action_goal = robot_scheduling_msgs.msg.worksheetrunActionGoal()
      self.action_result = robot_scheduling_msgs.msg.worksheetrunActionResult()
      self.action_feedback = robot_scheduling_msgs.msg.worksheetrunActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.action_feedback.feedback.current_index, _x.action_feedback.feedback.current_function))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_feedback.feedback.current_index, _x.action_feedback.feedback.current_function,) = _get_struct_2B().unpack(str[start:end])
      return self
