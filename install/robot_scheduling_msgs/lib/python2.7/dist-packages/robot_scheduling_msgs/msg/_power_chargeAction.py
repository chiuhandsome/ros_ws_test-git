...
"""autogenerated by genpy from robot_scheduling_msgs/power_chargeAction.msg. Do not edit."""
import sys
...
class power_chargeAction(genpy.Message):
  _md5sum = "8266ff4ea3587f4d580ee4f104204422"
  _type = "robot_scheduling_msgs/power_chargeAction"
...
"""
  ...
  _slot_types = ['robot_scheduling_msgs/power_chargeActionGoal','robot_scheduling_msgs/power_chargeActionResult','robot_scheduling_msgs/power_chargeActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(power_chargeAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = robot_scheduling_msgs.msg.power_chargeActionGoal()
      if self.action_result is None:
        self.action_result = robot_scheduling_msgs.msg.power_chargeActionResult()
      if self.action_feedback is None:
        self.action_feedback = robot_scheduling_msgs.msg.power_chargeActionFeedback()
    else:
      self.action_goal = robot_scheduling_msgs.msg.power_chargeActionGoal()
      self.action_result = robot_scheduling_msgs.msg.power_chargeActionResult()
      self.action_feedback = robot_scheduling_msgs.msg.power_chargeActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.charge_type
      buff.write(_get_struct_B().pack(_x))
      _x = self.action_goal.goal.charge_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_feedback.feedback.charge_fb_state
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.charge_type,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.charge_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.charge_id = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.charge_fb_state,) = _get_struct_B().unpack(str[start:end])
      return self
