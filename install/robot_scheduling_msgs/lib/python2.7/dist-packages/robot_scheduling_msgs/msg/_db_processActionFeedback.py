...
"""autogenerated by genpy from robot_scheduling_msgs/db_processActionFeedback.msg. Do not edit."""
import sys
...
class db_processActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "robot_scheduling_msgs/db_processActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/db_processFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(db_processActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = robot_scheduling_msgs.msg.db_processFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robot_scheduling_msgs.msg.db_processFeedback()
