...
"""autogenerated by genpy from robot_scheduling_msgs/worksheetrunActionResult.msg. Do not edit."""
import sys
...
class worksheetrunActionResult(genpy.Message):
  _md5sum = "752dc8d095973b2b2731ff056eebb0b0"
  _type = "robot_scheduling_msgs/worksheetrunActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_scheduling_msgs/worksheetrunResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(worksheetrunActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_scheduling_msgs.msg.worksheetrunResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_scheduling_msgs.msg.worksheetrunResult()
