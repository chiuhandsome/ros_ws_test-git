...
class pose_move_toResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new pose_move_toResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new pose_move_toResult(null);
...
module.exports = pose_move_toResult;
