...
class pose_move_to_recoveryResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new pose_move_to_recoveryResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new pose_move_to_recoveryResult(null);
...
pose_move_to_recoveryResult.Constants = {
  OK: 1,
}

module.exports = pose_move_to_recoveryResult;
