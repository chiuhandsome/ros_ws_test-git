...
class pose_move_toAction {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('action_goal')) {
        ...
        this.action_goal = new pose_move_toActionGoal();
      }
      if (initObj.hasOwnProperty('action_result')) {
        this.action_result = initObj.action_result
      }
      else {
        this.action_result = new pose_move_toActionResult();
      }
      if (initObj.hasOwnProperty('action_feedback')) {
        this.action_feedback = initObj.action_feedback
      }
      else {
        this.action_feedback = new pose_move_toActionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = pose_move_toActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = pose_move_toActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = pose_move_toActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new pose_move_toAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = pose_move_toActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = pose_move_toActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = pose_move_toActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += pose_move_toActionGoal.getMessageSize(object.action_goal);
    length += pose_move_toActionResult.getMessageSize(object.action_result);
    length += pose_move_toActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new pose_move_toAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = pose_move_toActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new pose_move_toActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = pose_move_toActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new pose_move_toActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = pose_move_toActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new pose_move_toActionFeedback()
    }
...
module.exports = pose_move_toAction;
