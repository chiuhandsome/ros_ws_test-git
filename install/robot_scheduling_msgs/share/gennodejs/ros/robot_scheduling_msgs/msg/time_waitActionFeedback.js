...
class time_waitActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new time_waitFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = time_waitFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new time_waitActionFeedback(null);
    ...
    data.feedback = time_waitFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new time_waitActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = time_waitFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new time_waitFeedback()
    }
...
module.exports = time_waitActionFeedback;
