...
class power_charge_recoveryActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new power_charge_recoveryGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = power_charge_recoveryGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new power_charge_recoveryActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = power_charge_recoveryGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new power_charge_recoveryActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = power_charge_recoveryGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new power_charge_recoveryGoal()
    }
...
module.exports = power_charge_recoveryActionGoal;
