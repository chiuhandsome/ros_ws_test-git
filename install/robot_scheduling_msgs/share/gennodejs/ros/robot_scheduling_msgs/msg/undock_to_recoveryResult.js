...
class undock_to_recoveryResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new undock_to_recoveryResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new undock_to_recoveryResult(null);
...
undock_to_recoveryResult.Constants = {
  OK: 1,
}

module.exports = undock_to_recoveryResult;
