...
class undock_toActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = undock_toGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += undock_toGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new undock_toActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = undock_toGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new undock_toGoal()
    }
...
module.exports = undock_toActionGoal;
