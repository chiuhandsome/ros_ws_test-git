...
"""autogenerated by genpy from tug_example_msgs/FetchBoxActionResult.msg. Do not edit."""
import sys
...
class FetchBoxActionResult(genpy.Message):
  _md5sum = "e8dcd53deffe9d196101baadc0cefb34"
  _type = "tug_example_msgs/FetchBoxActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tug_example_msgs/FetchBoxResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FetchBoxActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tug_example_msgs.msg.FetchBoxResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tug_example_msgs.msg.FetchBoxResult()
