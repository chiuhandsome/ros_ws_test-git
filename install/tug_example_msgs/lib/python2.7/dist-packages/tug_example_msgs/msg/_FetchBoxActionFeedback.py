...
"""autogenerated by genpy from tug_example_msgs/FetchBoxActionFeedback.msg. Do not edit."""
import sys
...
class FetchBoxActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "tug_example_msgs/FetchBoxActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tug_example_msgs/FetchBoxFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FetchBoxActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = tug_example_msgs.msg.FetchBoxFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = tug_example_msgs.msg.FetchBoxFeedback()
