...
class cell_agv_camera {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new cell_agv_camera(null);
  ...
  static datatype() {
    ...
    return 'cellctrl_control_msgs/cell_agv_camera';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_camera(null);
...
module.exports = cell_agv_camera;
