...
class cell_base_transfer {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new cell_base_transfer(null);
  ...
  static datatype() {
    ...
    return 'cellctrl_control_msgs/cell_base_transfer';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_base_transfer(null);
...
module.exports = cell_base_transfer;
