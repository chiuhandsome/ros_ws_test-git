...
class cell_agv_basetype {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new cell_agv_basetype(null);
  ...
  static datatype() {
    ...
    return 'cellctrl_control_msgs/cell_agv_basetype';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_basetype(null);
...
module.exports = cell_agv_basetype;
