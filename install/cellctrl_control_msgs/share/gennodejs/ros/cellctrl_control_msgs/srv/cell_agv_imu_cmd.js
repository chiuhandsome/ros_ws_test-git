...
let cell_agv_imu = require('../msg/cell_agv_imu.js');
...
class cell_agv_imu_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_agv_imu();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_imu_cmdRequest
    ...
    bufferOffset = cell_agv_imu.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_imu_cmdRequest
    let len;
    let data = new cell_agv_imu_cmdRequest(null);
    ...
    data.request_data = cell_agv_imu.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_agv_imu.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_agv_imu_cmdRequest';
  }
  ...
  static messageDefinition() {
    ...
    cell_agv_imu request_data	 
    
    ================================================================================
    MSG: cellctrl_control_msgs/cell_agv_imu
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_imu_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_agv_imu.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_agv_imu()
    }
...
class cell_agv_imu_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_imu_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_agv_imu.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_imu_cmdResponse
    let len;
    let data = new cell_agv_imu_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_agv_imu.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_agv_imu.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_agv_imu_cmdResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_imu_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_agv_imu.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_agv_imu_cmdRequest,
  Response: cell_agv_imu_cmdResponse,
  md5sum() { return '5b06aeba6c9560a399222d693fe7ca2c'; },
  datatype() { return 'cellctrl_control_msgs/cell_agv_imu_cmd'; }
};
