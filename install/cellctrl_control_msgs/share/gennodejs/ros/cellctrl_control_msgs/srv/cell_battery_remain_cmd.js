...
let cell_battery_remain = require('../msg/cell_battery_remain.js');
...
class cell_battery_remain_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_battery_remain();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_battery_remain_cmdRequest
    ...
    bufferOffset = cell_battery_remain.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_battery_remain_cmdRequest
    let len;
    let data = new cell_battery_remain_cmdRequest(null);
    ...
    data.request_data = cell_battery_remain.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_battery_remain.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_battery_remain_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e0652dfdb939316c23ce6e66dd217b3a';
  }
  ...
  static messageDefinition() {
    ...
    cell_battery_remain request_data	 
    
    ================================================================================
    MSG: cellctrl_control_msgs/cell_battery_remain
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_battery_remain_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_battery_remain.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_battery_remain()
    }
...
class cell_battery_remain_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_battery_remain_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_battery_remain.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_battery_remain_cmdResponse
    let len;
    let data = new cell_battery_remain_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_battery_remain.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_battery_remain.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_battery_remain_cmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'a3f597473e2331b3ce742b1376817108';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_battery_remain_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_battery_remain.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_battery_remain_cmdRequest,
  Response: cell_battery_remain_cmdResponse,
  md5sum() { return '04e8785354304652029d909ae1c4c266'; },
  datatype() { return 'cellctrl_control_msgs/cell_battery_remain_cmd'; }
};
