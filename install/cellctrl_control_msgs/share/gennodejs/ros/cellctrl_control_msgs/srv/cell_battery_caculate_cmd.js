...
let cell_battery_caculate = require('../msg/cell_battery_caculate.js');
...
class cell_battery_caculate_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_battery_caculate();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_battery_caculate_cmdRequest
    ...
    bufferOffset = cell_battery_caculate.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_battery_caculate_cmdRequest
    let len;
    let data = new cell_battery_caculate_cmdRequest(null);
    ...
    data.request_data = cell_battery_caculate.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_battery_caculate.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_battery_caculate_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '6c40b7d8026a79d9c56f76aecb0ff75d';
  }
  ...
  static messageDefinition() {
    ...
    cell_battery_caculate request_data	 
    
    ================================================================================
    MSG: cellctrl_control_msgs/cell_battery_caculate
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_battery_caculate_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_battery_caculate.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_battery_caculate()
    }
...
class cell_battery_caculate_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_battery_caculate_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_battery_caculate.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_battery_caculate_cmdResponse
    let len;
    let data = new cell_battery_caculate_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_battery_caculate.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_battery_caculate.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_battery_caculate_cmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '5252da2aefeea0defcf24e52844f259f';
  }
  ...
  static messageDefinition() {
    ...
    string primary_id
    string update_time
    cell_battery_caculate[] response_data
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_battery_caculate_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_battery_caculate.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_battery_caculate_cmdRequest,
  Response: cell_battery_caculate_cmdResponse,
  md5sum() { return 'dcdb5e464a630a6f21bef14a4fb71044'; },
  datatype() { return 'cellctrl_control_msgs/cell_battery_caculate_cmd'; }
};
