...
let cell_work_stationitems = require('../msg/cell_work_stationitems.js');
...
class cell_work_stationitems_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_work_stationitems();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_work_stationitems_cmdRequest
    ...
    bufferOffset = cell_work_stationitems.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_work_stationitems_cmdRequest
    let len;
    let data = new cell_work_stationitems_cmdRequest(null);
    ...
    data.request_data = cell_work_stationitems.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_work_stationitems.getMessageSize(object.request_data);
    return length + 13;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_work_stationitems_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_work_stationitems.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_work_stationitems()
    }
...
class cell_work_stationitems_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_work_stationitems_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_work_stationitems.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_work_stationitems_cmdResponse
    let len;
    let data = new cell_work_stationitems_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_work_stationitems.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_work_stationitems.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_work_stationitems_cmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '9aab7cddb680736c6f215e46bd0e8aa8';
  }
  ...
  static messageDefinition() {
    ...
    string primary_id
    string update_time
    cell_work_stationitems[] response_data
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_work_stationitems_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_work_stationitems.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_work_stationitems_cmdRequest,
  Response: cell_work_stationitems_cmdResponse,
  md5sum() { return 'f5dcc30f8209844bb8fa22dd2079027d'; },
  datatype() { return 'cellctrl_control_msgs/cell_work_stationitems_cmd'; }
};
