...
let cell_agv_motor = require('../msg/cell_agv_motor.js');
...
class cell_agv_motor_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_agv_motor();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_motor_cmdRequest
    ...
    bufferOffset = cell_agv_motor.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_motor_cmdRequest
    let len;
    let data = new cell_agv_motor_cmdRequest(null);
    ...
    data.request_data = cell_agv_motor.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_agv_motor.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_agv_motor_cmdRequest';
  }
  ...
  static messageDefinition() {
    ...
    cell_agv_motor request_data	 
    
    ================================================================================
    MSG: cellctrl_control_msgs/cell_agv_motor
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_motor_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_agv_motor.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_agv_motor()
    }
...
class cell_agv_motor_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_agv_motor_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_agv_motor.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_agv_motor_cmdResponse
    let len;
    let data = new cell_agv_motor_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_agv_motor.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_agv_motor.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_agv_motor_cmdResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_agv_motor_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_agv_motor.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_agv_motor_cmdRequest,
  Response: cell_agv_motor_cmdResponse,
  md5sum() { return '5b06aeba6c9560a399222d693fe7ca2c'; },
  datatype() { return 'cellctrl_control_msgs/cell_agv_motor_cmd'; }
};
