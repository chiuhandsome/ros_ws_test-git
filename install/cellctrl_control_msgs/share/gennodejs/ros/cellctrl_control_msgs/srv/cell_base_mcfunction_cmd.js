...
let cell_base_mcfunction = require('../msg/cell_base_mcfunction.js');
...
class cell_base_mcfunction_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_base_mcfunction();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_base_mcfunction_cmdRequest
    ...
    bufferOffset = cell_base_mcfunction.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_base_mcfunction_cmdRequest
    let len;
    let data = new cell_base_mcfunction_cmdRequest(null);
    ...
    data.request_data = cell_base_mcfunction.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_base_mcfunction.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_base_mcfunction_cmdRequest';
  }
  ...
  static messageDefinition() {
    ...
    cell_base_mcfunction request_data	 
    
    ================================================================================
    MSG: cellctrl_control_msgs/cell_base_mcfunction
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_base_mcfunction_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_base_mcfunction.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_base_mcfunction()
    }
...
class cell_base_mcfunction_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_base_mcfunction_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_base_mcfunction.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_base_mcfunction_cmdResponse
    let len;
    let data = new cell_base_mcfunction_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_base_mcfunction.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_base_mcfunction.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_base_mcfunction_cmdResponse';
  }
  ...
  static messageDefinition() {
    ...
    string primary_id
    string update_time
    cell_base_mcfunction[] response_data
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_base_mcfunction_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_base_mcfunction.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_base_mcfunction_cmdRequest,
  Response: cell_base_mcfunction_cmdResponse,
  md5sum() { return '85f1a82daa48541a5af3b253ddfbe595'; },
  datatype() { return 'cellctrl_control_msgs/cell_base_mcfunction_cmd'; }
};
