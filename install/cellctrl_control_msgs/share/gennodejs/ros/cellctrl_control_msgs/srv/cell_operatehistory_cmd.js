...
let cell_operatehistory = require('../msg/cell_operatehistory.js');
...
class cell_operatehistory_cmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('request_data')) {
        ...
        this.request_data = new cell_operatehistory();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_operatehistory_cmdRequest
    ...
    bufferOffset = cell_operatehistory.serialize(obj.request_data, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_operatehistory_cmdRequest
    let len;
    let data = new cell_operatehistory_cmdRequest(null);
    ...
    data.request_data = cell_operatehistory.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += cell_operatehistory.getMessageSize(object.request_data);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_operatehistory_cmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'b9452d6c325c7353d62d6e9fc9dbcea2';
  }
  ...
  static messageDefinition() {
    ...
    cell_operatehistory request_data	 
    
    ================================================================================
    MSG: cellctrl_control_msgs/cell_operatehistory
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_operatehistory_cmdRequest(null);
    ...
    if (msg.request_data !== undefined) {
      resolved.request_data = cell_operatehistory.Resolve(msg.request_data)
    }
    else {
      resolved.request_data = new cell_operatehistory()
    }
...
class cell_operatehistory_cmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cell_operatehistory_cmdResponse
    ...
    obj.response_data.forEach((val) => {
      bufferOffset = cell_operatehistory.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cell_operatehistory_cmdResponse
    let len;
    let data = new cell_operatehistory_cmdResponse(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.response_data[i] = cell_operatehistory.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.response_data.forEach((val) => {
      length += cell_operatehistory.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cellctrl_control_msgs/cell_operatehistory_cmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '3fd897fecfb44b079c8ce4d79dc73c52';
  }
  ...
  static messageDefinition() {
    ...
    string primary_id
    string update_time
    cell_operatehistory[] response_data
  ...
  static Resolve(msg) {
    ...
    const resolved = new cell_operatehistory_cmdResponse(null);
    ...
    if (msg.response_data !== undefined) {
      ...
      for (let i = 0; i < resolved.response_data.length; ++i) {
        resolved.response_data[i] = cell_operatehistory.Resolve(msg.response_data[i]);
      }
    }
    else {
...
module.exports = {
  Request: cell_operatehistory_cmdRequest,
  Response: cell_operatehistory_cmdResponse,
  md5sum() { return '023da57a2bf84d17920f3951de156983'; },
  datatype() { return 'cellctrl_control_msgs/cell_operatehistory_cmd'; }
};
