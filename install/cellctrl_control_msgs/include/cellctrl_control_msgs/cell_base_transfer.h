// Generated by gencpp from file cellctrl_control_msgs/cell_base_transfer.msg
// DO NOT EDIT!


#ifndef CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_BASE_TRANSFER_H
#define CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_BASE_TRANSFER_H
...
struct cell_base_transfer_
{
  typedef cell_base_transfer_<ContainerAllocator> Type;
  ...
  cell_base_transfer_(const ContainerAllocator& _alloc)
    : primary_id(_alloc)
    , unique_code(_alloc)
    , base_name(_alloc)
    , base_desc_TC(_alloc)
  ...
  typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> const> ConstPtr;

}; // struct cell_base_transfer_

typedef ::cellctrl_control_msgs::cell_base_transfer_<std::allocator<void> > cell_base_transfer;

typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_base_transfer > cell_base_transferPtr;
typedef boost::shared_ptr< ::cellctrl_control_msgs::cell_base_transfer const> cell_base_transferConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator1> & lhs, const ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7cae712ba514c233ULL;
  static const uint64_t static_value2 = 0x9344eb5e99f552cbULL;
};

template<class ContainerAllocator>
struct DataType< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cellctrl_control_msgs::cell_base_transfer_<ContainerAllocator>& v)
  {
    s << indent << "primary_id: ";
...
#endif // CELLCTRL_CONTROL_MSGS_MESSAGE_CELL_BASE_TRANSFER_H
