...
"""autogenerated by genpy from cellctrl_control_msgs/cell_base_mcfunction_cmdRequest.msg. Do not edit."""
import sys
...
class cell_base_mcfunction_cmdRequest(genpy.Message):
  _md5sum = "fa5d175c8e36a0a71eb126b242777010"
  _type = "cellctrl_control_msgs/cell_base_mcfunction_cmdRequest"
...
"""
  ...
  _slot_types = ['int8','string','string','string','cellctrl_control_msgs/cell_base_mcfunction']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_base_mcfunction_cmdRequest, self).__init__(*args, **kwds)
      ...
      if self.request_data is None:
        self.request_data = cellctrl_control_msgs.msg.cell_base_mcfunction()
    else:
      self.cmd_id = 0
      self.query_base_index = ''
      self.query_opt_index = ''
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cellctrl_control_msgs/cell_base_mcfunction_cmdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class cell_base_mcfunction_cmdResponse(genpy.Message):
  _md5sum = "f29cf7567c1ebf96078ebb5b8412efc8"
  _type = "cellctrl_control_msgs/cell_base_mcfunction_cmdResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','string','string','string','cellctrl_control_msgs/cell_base_mcfunction[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_base_mcfunction_cmdResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cellctrl_control_msgs.msg.cell_base_mcfunction()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
def _get_struct_B():
    ...
    if _struct_B is None:
        _struct_B = struct.Struct("<B")
    return _struct_B
class cell_base_mcfunction_cmd(object):
  _type          = 'cellctrl_control_msgs/cell_base_mcfunction_cmd'
  _md5sum = '85f1a82daa48541a5af3b253ddfbe595'
  _request_class  = cell_base_mcfunction_cmdRequest
  _response_class = cell_base_mcfunction_cmdResponse
