...
"""autogenerated by genpy from cellctrl_control_msgs/cell_operatehistory_cmdRequest.msg. Do not edit."""
import sys
...
class cell_operatehistory_cmdRequest(genpy.Message):
  _md5sum = "b9452d6c325c7353d62d6e9fc9dbcea2"
  _type = "cellctrl_control_msgs/cell_operatehistory_cmdRequest"
...
"""
  ...
  _slot_types = ['int8','string','string','string','cellctrl_control_msgs/cell_operatehistory']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_operatehistory_cmdRequest, self).__init__(*args, **kwds)
      ...
      if self.request_data is None:
        self.request_data = cellctrl_control_msgs.msg.cell_operatehistory()
    else:
      self.cmd_id = 0
      self.query_base_index = ''
      self.query_opt_index = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.request_data.operate_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.request_data.operate_type
      buff.write(_get_struct_B().pack(_x))
      _x = self.request_data.operate_code
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.request_data.operate_name = str[start:end].decode('utf-8')
      else:
        self.request_data.operate_name = str[start:end]
      start = end
      end += 1
      (self.request_data.operate_type,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.request_data.operate_code = str[start:end].decode('utf-8')
      else:
        self.request_data.operate_code = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cellctrl_control_msgs/cell_operatehistory_cmdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class cell_operatehistory_cmdResponse(genpy.Message):
  _md5sum = "3fd897fecfb44b079c8ce4d79dc73c52"
  _type = "cellctrl_control_msgs/cell_operatehistory_cmdResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','string','string','string','cellctrl_control_msgs/cell_operatehistory[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_operatehistory_cmdResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
    ...
    try:
      ...
      for val1 in self.response_data:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1.operate_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1.operate_type
        buff.write(_get_struct_B().pack(_x))
        _x = val1.operate_code
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cellctrl_control_msgs.msg.cell_operatehistory()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.operate_name = str[start:end].decode('utf-8')
        else:
          val1.operate_name = str[start:end]
        start = end
        end += 1
        (val1.operate_type,) = _get_struct_B().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.operate_code = str[start:end].decode('utf-8')
        else:
          val1.operate_code = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
def _get_struct_B():
    ...
    if _struct_B is None:
        _struct_B = struct.Struct("<B")
    return _struct_B
class cell_operatehistory_cmd(object):
  _type          = 'cellctrl_control_msgs/cell_operatehistory_cmd'
  _md5sum = '023da57a2bf84d17920f3951de156983'
  _request_class  = cell_operatehistory_cmdRequest
  _response_class = cell_operatehistory_cmdResponse
