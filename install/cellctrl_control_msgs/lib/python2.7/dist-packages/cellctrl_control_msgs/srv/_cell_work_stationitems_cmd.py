...
"""autogenerated by genpy from cellctrl_control_msgs/cell_work_stationitems_cmdRequest.msg. Do not edit."""
import sys
...
class cell_work_stationitems_cmdRequest(genpy.Message):
  _md5sum = "cac7e146be8e24cbf8798b89dea8d2e1"
  _type = "cellctrl_control_msgs/cell_work_stationitems_cmdRequest"
...
"""
  ...
  _slot_types = ['int8','string','string','string','cellctrl_control_msgs/cell_work_stationitems']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_work_stationitems_cmdRequest, self).__init__(*args, **kwds)
      ...
      if self.request_data is None:
        self.request_data = cellctrl_control_msgs.msg.cell_work_stationitems()
    else:
      self.cmd_id = 0
      self.query_base_index = ''
      self.query_opt_index = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.request_data.station_ser
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.request_data.station_ser,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cellctrl_control_msgs/cell_work_stationitems_cmdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class cell_work_stationitems_cmdResponse(genpy.Message):
  _md5sum = "9aab7cddb680736c6f215e46bd0e8aa8"
  _type = "cellctrl_control_msgs/cell_work_stationitems_cmdResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','string','string','string','cellctrl_control_msgs/cell_work_stationitems[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cell_work_stationitems_cmdResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cellctrl_control_msgs.msg.cell_work_stationitems()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        (val1.station_ser,) = _get_struct_B().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
def _get_struct_B():
    ...
    if _struct_B is None:
        _struct_B = struct.Struct("<B")
    return _struct_B
class cell_work_stationitems_cmd(object):
  _type          = 'cellctrl_control_msgs/cell_work_stationitems_cmd'
  _md5sum = 'f5dcc30f8209844bb8fa22dd2079027d'
  _request_class  = cell_work_stationitems_cmdRequest
  _response_class = cell_work_stationitems_cmdResponse
