...
"""autogenerated by genpy from cellctrl_control_msgs/cell_agv_battery.msg. Do not edit."""
import sys
...
class cell_agv_battery(genpy.Message):
  _md5sum = "5eb3a13fc49984edf8e4c2f85255eb85"
  _type = "cellctrl_control_msgs/cell_agv_battery"
...
"""
  __slots__ = ['primary_id','foreign_key','unique_code','tagname','tag_ser','device_code','device_serialno','caculate_code','remain_code','put_in_service_date','work_comulative_time','current_status','current_capacity','update_time']
  _slot_types = ['string','string','string','string','uint8','string','string','string','string','string','float32','uint8','float32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       primary_id,foreign_key,unique_code,tagname,tag_ser,device_code,device_serialno,caculate_code,remain_code,put_in_service_date,work_comulative_time,current_status,current_capacity,update_time
    ...
    """
    if args or kwds:
      super(cell_agv_battery, self).__init__(*args, **kwds)
      ...
      if self.caculate_code is None:
        self.caculate_code = ''
      if self.remain_code is None:
        self.remain_code = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.caculate_code = str[start:end].decode('utf-8')
      else:
        self.caculate_code = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.remain_code = str[start:end].decode('utf-8')
      else:
        self.remain_code = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
