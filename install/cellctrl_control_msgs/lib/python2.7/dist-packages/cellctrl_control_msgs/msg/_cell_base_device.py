...
"""autogenerated by genpy from cellctrl_control_msgs/cell_base_device.msg. Do not edit."""
import sys
...
class cell_base_device(genpy.Message):
  _md5sum = "691e7cd179322514a4f721edc2196641"
  _type = "cellctrl_control_msgs/cell_base_device"
...
"""
  __slots__ = ['primary_id','unique_code','base_name','factory','modelno','base_desc_TC','base_desc_SC','base_desc_E','update_time']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       primary_id,unique_code,base_name,factory,modelno,base_desc_TC,base_desc_SC,base_desc_E,update_time
    ...
    """
    if args or kwds:
      super(cell_base_device, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.factory = str[start:end].decode('utf-8')
      else:
        self.factory = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.modelno = str[start:end].decode('utf-8')
      else:
        self.modelno = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
