...
"""autogenerated by genpy from botcmd_msgs/bot_battery.msg. Do not edit."""
import sys
...
class bot_battery(genpy.Message):
  _md5sum = "2025128134cea8691154663daed5045a"
  _type = "botcmd_msgs/bot_battery"
...
"""
  __slots__ = ['stamp','gen_alarmcode','emg_alarmcode','chargstate_code','cell_balance_code','cell_volt_min','cell_volt_max','chargcurrent_code','full_capacity','loop_counter','cell_temp_min','cell_temp_max','Pack_tol_volt','Pack_resistance','total_discharge','ASOC_code','scaleunit_code']
  _slot_types = ['time','int16','int16','int16','int16','int16','int16','int16','int16','int16','int8','int8','int16','int16','int32','int16','int16']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       stamp,gen_alarmcode,emg_alarmcode,chargstate_code,cell_balance_code,cell_volt_min,cell_volt_max,chargcurrent_code,full_capacity,loop_counter,cell_temp_min,cell_temp_max,Pack_tol_volt,Pack_resistance,total_discharge,ASOC_code,scaleunit_code
    ...
    """
    if args or kwds:
      super(bot_battery, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.stamp.secs, _x.stamp.nsecs, _x.gen_alarmcode, _x.emg_alarmcode, _x.chargstate_code, _x.cell_balance_code, _x.cell_volt_min, _x.cell_volt_max, _x.chargcurrent_code, _x.full_capacity, _x.loop_counter, _x.cell_temp_min, _x.cell_temp_max, _x.Pack_tol_volt, _x.Pack_resistance, _x.total_discharge, _x.ASOC_code, _x.scaleunit_code,) = _get_struct_2I9h2b2hi2h().unpack(str[start:end])
      self.stamp.canon()
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2I9h2b2hi2h = None
def _get_struct_2I9h2b2hi2h():
    global _struct_2I9h2b2hi2h
    if _struct_2I9h2b2hi2h is None:
        _struct_2I9h2b2hi2h = struct.Struct("<2I9h2b2hi2h")
    return _struct_2I9h2b2hi2h
