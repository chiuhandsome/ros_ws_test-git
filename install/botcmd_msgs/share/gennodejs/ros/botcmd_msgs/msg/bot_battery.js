...
class bot_battery {
  ...
  static datatype() {
    ...
    return 'botcmd_msgs/bot_battery';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '2025128134cea8691154663daed5045a';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new bot_battery(null);
