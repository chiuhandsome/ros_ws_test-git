...
(cl:defclass <samsung_alarmHistory> (roslisp-msg-protocol:ros-message)
  ((system_id
    :reader system_id
    :initarg :system_id
    :type cl:string
...
(cl:defclass samsung_alarmHistory (<samsung_alarmHistory>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <samsung_alarmHistory>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'samsung_alarmHistory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name samsungcmd_msgs-msg:<samsung_alarmHistory> is deprecated: use samsungcmd_msgs-msg:samsung_alarmHistory instead.")))

(cl:ensure-generic-function 'system_id-val :lambda-list '(m))
(cl:defmethod system_id-val ((m <samsung_alarmHistory>))
...
(cl:defmethod alarm_id-val ((m <samsung_alarmHistory>))
...
(cl:defmethod alarm_code-val ((m <samsung_alarmHistory>))
...
(cl:defmethod alarm_level-val ((m <samsung_alarmHistory>))
...
(cl:defmethod alarm_occure_time-val ((m <samsung_alarmHistory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader samsungcmd_msgs-msg:alarm_occure_time-val is deprecated.  Use samsungcmd_msgs-msg:alarm_occure_time instead.")
  (alarm_occure_time m))

(cl:ensure-generic-function 'alarm_update_time-val :lambda-list '(m))
(cl:defmethod alarm_update_time-val ((m <samsung_alarmHistory>))
  ...
  (alarm_update_time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <samsung_alarmHistory>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <samsung_alarmHistory>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<samsung_alarmHistory>)))
  "Returns string type for a message object of type '<samsung_alarmHistory>"
  "samsungcmd_msgs/samsung_alarmHistory")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'samsung_alarmHistory)))
  "Returns string type for a message object of type 'samsung_alarmHistory"
  "samsungcmd_msgs/samsung_alarmHistory")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<samsung_alarmHistory>)))
  "Returns md5sum for a message object of type '<samsung_alarmHistory>"
  "8eaf1cb50ac427c6ec57697237bdf914")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'samsung_alarmHistory)))
  "Returns md5sum for a message object of type 'samsung_alarmHistory"
  "8eaf1cb50ac427c6ec57697237bdf914")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<samsung_alarmHistory>)))
  "Returns full string definition for message of type '<samsung_alarmHistory>"
  (cl:format cl:nil "string system_id ~%string alarm_id 			# module_no(3) + module alarm code(3)	~%string alarm_code 			# same as alarm_id,preper for special requirement~%string alarm_level 			# level of ararm: 1:alart 2:alarm	~%string alarm_occure_time 	# occure time of alarm~%string alarm_update_time ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'samsung_alarmHistory)))
  "Returns full string definition for message of type 'samsung_alarmHistory"
  (cl:format cl:nil "string system_id ~%string alarm_id 			# module_no(3) + module alarm code(3)	~%string alarm_code 			# same as alarm_id,preper for special requirement~%string alarm_level 			# level of ararm: 1:alart 2:alarm	~%string alarm_occure_time 	# occure time of alarm~%string alarm_update_time ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <samsung_alarmHistory>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <samsung_alarmHistory>))
  "Converts a ROS message object to a list"
  (cl:list 'samsung_alarmHistory
