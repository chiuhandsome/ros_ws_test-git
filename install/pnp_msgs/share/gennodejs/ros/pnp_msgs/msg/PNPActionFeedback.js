...
let PNPFeedback = require('./PNPFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PNPActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PNPFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PNPActionFeedback(null);
    ...
    data.feedback = PNPFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PNPFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PNPActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PNPFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PNPFeedback()
    }
...
module.exports = PNPActionFeedback;
