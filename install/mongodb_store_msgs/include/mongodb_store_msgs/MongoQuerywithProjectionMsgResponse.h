...
bool operator==(const ::mongodb_store_msgs::MongoQuerywithProjectionMsgResponse_<ContainerAllocator1> & lhs, const ::mongodb_store_msgs::MongoQuerywithProjectionMsgResponse_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::mongodb_store_msgs::MongoQuerywithProjectionMsgResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# messages which match the query\n"
