...
bool operator==(const ::mongodb_store_msgs::MongoUpdateMsgRequest_<ContainerAllocator1> & lhs, const ::mongodb_store_msgs::MongoUpdateMsgRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::mongodb_store_msgs::MongoUpdateMsgRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# message used for updating matching ROS msgs from a MongoDB database\n"
"\n"
"string database\n"
"string collection\n"
