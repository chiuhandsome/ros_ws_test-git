...
bool operator==(const ::mongodb_store_msgs::MongoDeleteMsgRequest_<ContainerAllocator1> & lhs, const ::mongodb_store_msgs::MongoDeleteMsgRequest_<ContainerAllocator2> & rhs)
{
