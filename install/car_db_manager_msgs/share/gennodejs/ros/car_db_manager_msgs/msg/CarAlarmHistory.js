...
class CarAlarmHistory {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CarAlarmHistory(null);
  ...
  static datatype() {
    ...
    return 'car_db_manager_msgs/CarAlarmHistory';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CarAlarmHistory(null);
...
module.exports = CarAlarmHistory;
