...
class car_db_process_recoveryActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new car_db_process_recoveryGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = car_db_process_recoveryGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new car_db_process_recoveryActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = car_db_process_recoveryGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new car_db_process_recoveryActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = car_db_process_recoveryGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new car_db_process_recoveryGoal()
    }
...
module.exports = car_db_process_recoveryActionGoal;
