...
let CheckParameters = require('../msg/CheckParameters.js');
...
class CheckParametersCmdRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.req_check_parameters = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('req_check_parameters')) {
        this.req_check_parameters = initObj.req_check_parameters
      }
      else {
        this.req_check_parameters = new CheckParameters();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CheckParametersCmdRequest
    ...
    // Serialize message field [req_check_parameters]
    bufferOffset = CheckParameters.serialize(obj.req_check_parameters, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CheckParametersCmdRequest
    let len;
    let data = new CheckParametersCmdRequest(null);
    ...
    // Deserialize message field [req_check_parameters]
    data.req_check_parameters = CheckParameters.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += CheckParameters.getMessageSize(object.req_check_parameters);
    return length + 13;
  }

  static datatype() {
    // Returns string type for a service object
    return 'car_db_manager_msgs/CheckParametersCmdRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '68c931b9ba624380d57d36336a8f5f26';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CheckParametersCmdRequest(null);
    ...
    if (msg.req_check_parameters !== undefined) {
      resolved.req_check_parameters = CheckParameters.Resolve(msg.req_check_parameters)
    }
    else {
      resolved.req_check_parameters = new CheckParameters()
    }
...
class CheckParametersCmdResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
      ...
      this.result_check_parameters = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('result_check_parameters')) {
        this.result_check_parameters = initObj.result_check_parameters
      }
      else {
        this.result_check_parameters = [];
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CheckParametersCmdResponse
    ...
    // Serialize message field [result_check_parameters]
    // Serialize the length for message field [result_check_parameters]
    bufferOffset = _serializer.uint32(obj.result_check_parameters.length, buffer, bufferOffset);
    obj.result_check_parameters.forEach((val) => {
      bufferOffset = CheckParameters.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CheckParametersCmdResponse
    let len;
    let data = new CheckParametersCmdResponse(null);
    ...
    // Deserialize message field [result_check_parameters]
    // Deserialize array length for message field [result_check_parameters]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.result_check_parameters = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.result_check_parameters[i] = CheckParameters.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.result_check_parameters.forEach((val) => {
      length += CheckParameters.getMessageSize(val);
    });
    return length + 17;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'car_db_manager_msgs/CheckParametersCmdResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'c8949200475937e7210289cd1d6aa8bc';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CheckParametersCmdResponse(null);
    ...
    if (msg.result_check_parameters !== undefined) {
      resolved.result_check_parameters = new Array(msg.result_check_parameters.length);
      for (let i = 0; i < resolved.result_check_parameters.length; ++i) {
        resolved.result_check_parameters[i] = CheckParameters.Resolve(msg.result_check_parameters[i]);
      }
    }
    else {
      resolved.result_check_parameters = []
    }
...
module.exports = {
  Request: CheckParametersCmdRequest,
  Response: CheckParametersCmdResponse,
  md5sum() { return '67b016518b6edaa947e54833be560697'; },
  datatype() { return 'car_db_manager_msgs/CheckParametersCmd'; }
};
