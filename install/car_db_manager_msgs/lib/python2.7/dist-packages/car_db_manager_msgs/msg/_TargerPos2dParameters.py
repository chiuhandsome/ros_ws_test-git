...
"""autogenerated by genpy from car_db_manager_msgs/TargerPos2dParameters.msg. Do not edit."""
import sys
...
class TargerPos2dParameters(genpy.Message):
  _md5sum = "8e6a4b469b6e6718a5c3a4cc673a88f1"
  _type = "car_db_manager_msgs/TargerPos2dParameters"
...
"""
  __slots__ = ['primary_id','unique_code','base_name','pos_x','pos_y','theta','rotate_flag','update_time']
  _slot_types = ['string','string','string','float32','float32','float32','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       primary_id,unique_code,base_name,pos_x,pos_y,theta,rotate_flag,update_time
    ...
    """
    if args or kwds:
      super(TargerPos2dParameters, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.rotate_flag = bool(self.rotate_flag)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
