...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryPointMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryPointMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teb2_local_planner-msg:<TrajectoryPointMsg> is deprecated: use teb2_local_planner-msg:TrajectoryPointMsg instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <TrajectoryPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teb2_local_planner-msg:pose-val is deprecated.  Use teb2_local_planner-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <TrajectoryPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teb2_local_planner-msg:velocity-val is deprecated.  Use teb2_local_planner-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <TrajectoryPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teb2_local_planner-msg:acceleration-val is deprecated.  Use teb2_local_planner-msg:acceleration instead.")
  (acceleration m))

(cl:ensure-generic-function 'time_from_start-val :lambda-list '(m))
(cl:defmethod time_from_start-val ((m <TrajectoryPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teb2_local_planner-msg:time_from_start-val is deprecated.  Use teb2_local_planner-msg:time_from_start instead.")
  (time_from_start m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrajectoryPointMsg>)))
  ...
  "teb2_local_planner/TrajectoryPointMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrajectoryPointMsg)))
  "Returns string type for a message object of type 'TrajectoryPointMsg"
  "teb2_local_planner/TrajectoryPointMsg")
