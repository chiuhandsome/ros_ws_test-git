...
// (in-package teb2_local_planner.msg)
...
class FeedbackMsg {
  ...
  static datatype() {
    ...
    return 'teb2_local_planner/FeedbackMsg';
  }
  ...
  static messageDefinition() {
    ...
    teb2_local_planner/TrajectoryMsg[] trajectories
    ...
    ================================================================================
    MSG: teb2_local_planner/TrajectoryMsg
    # Message that contains a trajectory for mobile robot navigation
    
    std_msgs/Header header
    teb2_local_planner/TrajectoryPointMsg[] trajectory
    
    
    
    ================================================================================
    MSG: teb2_local_planner/TrajectoryPointMsg
