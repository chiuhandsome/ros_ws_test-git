...
class actionlib_pre_dockGoal {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new actionlib_pre_dockGoal(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new actionlib_pre_dockGoal(null);
...
module.exports = actionlib_pre_dockGoal;
