...
class actionlib_post_undockFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new actionlib_post_undockFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new actionlib_post_undockFeedback(null);
...
module.exports = actionlib_post_undockFeedback;
