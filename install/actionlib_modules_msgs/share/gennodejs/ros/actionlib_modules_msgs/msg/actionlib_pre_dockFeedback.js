...
class actionlib_pre_dockFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new actionlib_pre_dockFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new actionlib_pre_dockFeedback(null);
...
module.exports = actionlib_pre_dockFeedback;
