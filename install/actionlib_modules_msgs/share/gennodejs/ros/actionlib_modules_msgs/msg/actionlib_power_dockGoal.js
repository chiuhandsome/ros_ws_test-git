...
class actionlib_power_dockGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new actionlib_power_dockGoal(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new actionlib_power_dockGoal(null);
...
module.exports = actionlib_power_dockGoal;
