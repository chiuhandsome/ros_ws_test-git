...
class recovery_timeout_actionlib_pre_dockActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new recovery_timeout_actionlib_pre_dockGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = recovery_timeout_actionlib_pre_dockGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new recovery_timeout_actionlib_pre_dockActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = recovery_timeout_actionlib_pre_dockGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new recovery_timeout_actionlib_pre_dockActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = recovery_timeout_actionlib_pre_dockGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new recovery_timeout_actionlib_pre_dockGoal()
    }
...
module.exports = recovery_timeout_actionlib_pre_dockActionGoal;
