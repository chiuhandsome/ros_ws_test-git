...
class actionlib_agv_movetoFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('state')) {
        ...
        this.state = new locomotor_msgs.msg.NavigationState();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = locomotor_msgs.msg.NavigationState.serialize(obj.state, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new actionlib_agv_movetoFeedback(null);
    // Deserialize message field [state]
    data.state = locomotor_msgs.msg.NavigationState.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += locomotor_msgs.msg.NavigationState.getMessageSize(object.state);
    return length + 12;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new actionlib_agv_movetoFeedback(null);
    if (msg.state !== undefined) {
      resolved.state = locomotor_msgs.msg.NavigationState.Resolve(msg.state)
    }
    else {
      resolved.state = new locomotor_msgs.msg.NavigationState()
    }
...
module.exports = actionlib_agv_movetoFeedback;
