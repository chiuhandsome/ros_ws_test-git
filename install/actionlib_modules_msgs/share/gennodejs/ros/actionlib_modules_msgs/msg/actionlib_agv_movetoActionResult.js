...
class actionlib_agv_movetoActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new actionlib_agv_movetoResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = actionlib_agv_movetoResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new actionlib_agv_movetoActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = actionlib_agv_movetoResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += actionlib_agv_movetoResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new actionlib_agv_movetoActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = actionlib_agv_movetoResult.Resolve(msg.result)
    }
    else {
      resolved.result = new actionlib_agv_movetoResult()
    }
...
module.exports = actionlib_agv_movetoActionResult;
