...
class actionlib_power_dockFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new actionlib_power_dockFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new actionlib_power_dockFeedback(null);
...
module.exports = actionlib_power_dockFeedback;
