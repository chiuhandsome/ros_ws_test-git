...
class recovery_timeout_actionlib_post_undockActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new recovery_timeout_actionlib_post_undockFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = recovery_timeout_actionlib_post_undockFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new recovery_timeout_actionlib_post_undockActionFeedback(null);
    ...
    data.feedback = recovery_timeout_actionlib_post_undockFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new recovery_timeout_actionlib_post_undockActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = recovery_timeout_actionlib_post_undockFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new recovery_timeout_actionlib_post_undockFeedback()
    }
...
module.exports = recovery_timeout_actionlib_post_undockActionFeedback;
