...
(cl:defmethod cl:initialize-instance :after ((m <TurnGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rp_action_msgs-msg:<TurnGoal> is deprecated: use rp_action_msgs-msg:TurnGoal instead.")))

(cl:ensure-generic-function 'target_angle-val :lambda-list '(m))
(cl:defmethod target_angle-val ((m <TurnGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rp_action_msgs-msg:target_angle-val is deprecated.  Use rp_action_msgs-msg:target_angle instead.")
  (target_angle m))

(cl:ensure-generic-function 'absolute_relative_flag-val :lambda-list '(m))
(cl:defmethod absolute_relative_flag-val ((m <TurnGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rp_action_msgs-msg:absolute_relative_flag-val is deprecated.  Use rp_action_msgs-msg:absolute_relative_flag instead.")
  (absolute_relative_flag m))

(cl:ensure-generic-function 'max_ang_vel-val :lambda-list '(m))
(cl:defmethod max_ang_vel-val ((m <TurnGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rp_action_msgs-msg:max_ang_vel-val is deprecated.  Use rp_action_msgs-msg:max_ang_vel instead.")
  (max_ang_vel m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <TurnGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rp_action_msgs-msg:name-val is deprecated.  Use rp_action_msgs-msg:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TurnGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Goal~%# target_angle [DEG] ~%float32 target_angle~%# flag ABS/REL~%string absolute_relative_flag~%# max angular velocity [DEG/s]~%float32 max_ang_vel~%#robot name~%string name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TurnGoal)))
  "Returns full string definition for message of type 'TurnGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Goal~%# target_angle [DEG] ~%float32 target_angle~%# flag ABS/REL~%string absolute_relative_flag~%# max angular velocity [DEG/s]~%float32 max_ang_vel~%#robot name~%string name~%~%~%"))
