...
"""autogenerated by genpy from rp_action_msgs/TurnActionResult.msg. Do not edit."""
import sys
...
class TurnActionResult(genpy.Message):
  ...
  _type = "rp_action_msgs/TurnActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rp_action_msgs/TurnResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = rp_action_msgs.msg.TurnResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rp_action_msgs.msg.TurnResult()
